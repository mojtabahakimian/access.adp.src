...
Begin Report
    ...
    Tag ="@Forms___FMENU_TARAZ_4___DT1 = [Forms]![FMENU_TARAZ_4]![DT1],@Forms___FMENU_TARA"
        ...
        "ARAZ_4]![SNDNUM2],@kol = [Forms]![FMENU_TARAZ_4]![hhhs],@MOIN = [Forms]![FMENU_T"
        "ARAZ_4]![hhhM]"
        ...
        Begin PageHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    BorderColor =0
                    Name ="Text223"
                    ControlSource ="=Format(Str([bedAN]),\"#,###\") & \"  \""
                    Format ="#,###"
                    FontName ="Traffic"
                End
                Begin Line
                ...
                Begin TextBox
                    ...
                    BorderColor =0
                    Name ="Text226"
                    ControlSource ="=Format(Str([besAN]),\"#,###\") & \"  \""
                    Format ="#,###"
                    FontName ="Traffic"
                End
                Begin Line
                ...
                Begin TextBox
                    ...
                    BorderColor =0
                    Name ="Text102"
                    ControlSource ="=Format(Str([SumOfBEDAN]),\"#,###\") & \"  \""
                    Format ="#,###"
                    FontName ="Traffic"
                End
                Begin Line
                ...
                Begin TextBox
                    ...
                    BorderColor =0
                    Name ="Text104"
                    ControlSource ="=Format(Str([SumOfBESAN]),\"#,###\") & \"  \""
                    Format ="#,###"
                    FontName ="Traffic"
                End
                Begin Line
