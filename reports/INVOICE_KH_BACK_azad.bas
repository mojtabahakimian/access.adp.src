...
Begin Report
    ...
    RecSrcDt = Begin
        0x847e929b5303e540
    End
    RecordSource ="QSL_INVOICE_KH_BACK_azad"
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="NPAR"
                    ControlSource ="=[Forms]![HEAD_LST_KH_BACK_azad]![NPAR]"
                    Format ="#,##0.00;-#,##0.00"
                    FontName ="WeblogmaYekan"
                    Begin
                        Begin Label
                ...
                Begin TextBox
                    ...
                    TabIndex =2
                    Name ="JF"
                    ControlSource ="=[Forms]![HEAD_LST_KH_BACK_azad]![JF]"
                    Format ="#,##0.00;-#,##0.00"
                    FontName ="WeblogmaYekan"
                    Begin
                        Begin Label
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="HKH"
                    ControlSource ="=[Forms]![HEAD_LST_KH_BACK_azad]![HKH]"
                    Format ="#,##0.00;-#,##0.00"
                    FontName ="WeblogmaYekan"
                    Begin
                        Begin Label
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="NTKHFIF"
                    ControlSource ="=[Forms]![HEAD_LST_KH_BACK_azad]![NTKHFIF]"
                    Format ="#,##0.00;-#,##0.00"
                    FontName ="WeblogmaYekan"
                    Begin
                        Begin Label
                ...
                Begin TextBox
                    ...
                    BackColor =16777164
                    Name ="GHABEL"
                    ControlSource ="=[Forms]![HEAD_LST_KH_BACK_azad]![GHABEL]"
                    Format ="#,##0.00;-#,##0.00"
                    FontName ="WeblogmaYekan"
                    Begin
                        Begin Label
                ...
                Begin TextBox
                    ...
                    BackColor =16777164
                    Name ="Text98"
                    ControlSource ="=[Forms]![HEAD_LST_KH_BACK_azad]![MAN]"
                    Format ="#,##0.00;#,##0.00-"
                    FontName ="WeblogmaYekan"
                    Begin
                        Begin Label
                ...
                Begin TextBox
                    ...
                    BackColor =128
                    Name ="MANDAH"
                    ControlSource ="=[Forms]![HEAD_LST_KH_BACK_azad]![MANDAH]"
                    FontName ="WeblogmaYekan"
                    Begin
                        Begin Label
                            TextAlign =0
                ...
                Begin TextBox
                    ...
                    TabIndex =8
                    Name ="Text165"
                    ControlSource ="=[Forms]![HEAD_LST_KH_BACK_azad]![mbaa]"
                    Format ="#,##0.00;-#,##0.00"
                    FontName ="WeblogmaYekan"
                    Begin
                        Begin Label
