...
Begin Report
    ...
    RecSrcDt = Begin
        0x99915491726fe340
    End
    InputParameters ="@Forms___F_MENU_KOL_DATE___DT1=[Forms]![F_MENU_KOL_DATE]![DT1] ,@Forms___F_MENU_"
        "KOL_DATE___DT2=[Forms]![F_MENU_KOL_DATE]![DT2],@Forms___F_MENU_KOL_DATE___HKOL=["
        "FormS]![F_MENU_KOL_DATE]![HKOL],@Forms___F_MENU_KOL_DATE___HKOL2=[FormS]![F_MENU"
        "_KOL_DATE]![HKOL2]"
    RecordSource ="Q_DAFTAR_KOL1"
    Caption ="دفتر  كل"
    OnOpen ="[Event Procedure]"
    OnClose ="[Event Procedure]"
    DatasheetFontName ="Arial (Arabic)"
    OnError ="[Event Procedure]"
    UnknownProp = {258 ,66 ,12 ,4 ,516 } Begin
        0x400046006f0072006d0073005f005f005f0046005f004d0045004e0055005f00 ,
        0x4b004f004c005f0044004100540045005f005f005f004400540031003d005b00 ,
        0x46006f0072006d0073005d0021005b0046005f004d0045004e0055005f004b00 ,
        0x4f004c005f0044004100540045005d0021005b004400540031005d0020002c00 ,
        0x400046006f0072006d0073005f005f005f0046005f004d0045004e0055005f00 ,
        0x4b004f004c005f0044004100540045005f005f005f004400540032003d005b00 ,
        0x46006f0072006d0073005d0021005b0046005f004d0045004e0055005f004b00 ,
        0x4f004c005f0044004100540045005d0021005b004400540032005d002c004000 ,
        0x46006f0072006d0073005f005f005f0046005f004d0045004e0055005f004b00 ,
        0x4f004c005f0044004100540045005f005f005f0048004b004f004c003d005b00 ,
        0x46006f0072006d0053005d0021005b0046005f004d0045004e0055005f004b00 ,
        0x4f004c005f0044004100540045005d0021005b0048004b004f004c005d002c00 ,
        0x400046006f0072006d0073005f005f005f0046005f004d0045004e0055005f00 ,
        0x4b004f004c005f0044004100540045005f005f005f0048004b004f004c003200 ,
        0x3d005b0046006f0072006d0053005d0021005b0046005f004d0045004e005500 ,
        0x5f004b004f004c005f0044004100540045005d0021005b0048004b004f004c00 ,
        0x32005d00
    End
        ...
        Begin PageHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text52"
                    ControlSource ="=[Forms]![F_MENU_KOL_DATE]![DT2]"
                    FontName ="Zar"
                    InputMask ="####/##/##"
                End
                Begin TextBox
                    ...
                    TabIndex =2
                    Name ="Text53"
                    ControlSource ="=[Forms]![F_MENU_KOL_DATE]![DT1]"
                    FontName ="Zar"
                    InputMask ="####/##/##"
                End
                Begin Label
                ...
                Begin UnboundObjectFrame
                    ...
                    OleData = Begin
                        ...
                        0x0000004600000000000000000000000080e7c2875bb4d70103000000c00a0000 ,
                ...
                Begin TextBox
                    ...
                    TabIndex =10
                    Name ="Text79"
                    ControlSource ="=IIf(([SAN]-[bed])-([sas]-[bes])>0,IIf(([SAN]-[bed])-([sas]-[bes])=0,\"--\",\"بد"
                        "\"),IIf(([SAN]-[bed])-([sas]-[bes])=0,\"--\",\"بس\"))"
                    FontName ="Traffic"
                    Tag ="=IIf(([SAN]-[bed])-([sas]-[bes])>0;IIf(([SAN]-[bed])-([sas]-[bes])=0;\"--\";\"بد"
                        "\");IIf(([SAN]-[bed])-([sas]-[bes])=0;\"--\";\"بس\"))"
                End
                Begin Line
                    LineSlant = NotDefault
