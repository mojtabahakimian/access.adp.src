create  FUNCTION [dbo].[Q_FROOSH_DAYLY_HED2_MBA]
...
                       dbo.CUST_HESAB.NAME, SUM(dbo.HEAD_LST.MBAA) AS SMBAA, dbo.CUST_HESAB.hes, dbo.CUST_HESAB.ADDRESS, dbo.CUST_HESAB.TEL, 
                       dbo.CUST_HESAB.CODE_E, dbo.CUST_HESAB.ECODE, dbo.CUST_HESAB.PCODE, dbo.CUST_HESAB.IYALAT, dbo.CUST_HESAB.CITY, 
                       dbo.CUST_HESAB.MCODEM, dbo.CUST_HESAB.TOZIH, dbo.CUST_HESAB.CUST_COD, dbo.CUST_HESAB.MOBILE
 FROM         dbo.HEAD_LST INNER JOIN
                       dbo.CUST_HESAB ON dbo.HEAD_LST.CUST_NO = dbo.CUST_HESAB.hes
 WHERE     (dbo.HEAD_LST.TAG = 2) AND (dbo.HEAD_LST.DATE_N BETWEEN @Forms___F_MENU_GOZARESH_FROOSH___DT1 AND 
...
                       dbo.CUST_HESAB.TOZIH, dbo.CUST_HESAB.CUST_COD, dbo.CUST_HESAB.MOBILE )
