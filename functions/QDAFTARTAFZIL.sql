CREATE FUNCTION [dbo].[QDAFTARTAFZIL]
 ...
 RETURN ( SELECT     TOP 100 PERCENT dbo.DEED_HED.N_S, dbo.DEED_HED.base, dbo.DEED_HED.DATE_S, dbo.DEED_DTL.HES_K, dbo.DEED_DTL.HES_M, dbo.DEED_DTL.HES_T, 
                      ...
                      dbo.DETA_HES.NAME AS MOIN, dbo.TDETA_HES.NAME AS TAFZIL, dbo.DEED_DTL.id, dbo.DEED_HED.NO_S, dbo.DEED_DTL.N_SERI, dbo.DEED_DTL.BANK, 
...
ORDER BY dbo.DEED_HED.DATE_S
 ...
 UNION
 SELECT     NN, 0 AS BASE, MaxOfDATE_S, HES_K, HES_M, HES_T, SHARH, dbo.UIIF(MAND, '>', 0, MAND, 0) AS BED, dbo.UIIF(MAND, '>', 0, 0, MAND * - 1) AS BES, MAND, 
                      NAME, MOIN, TAFZIL, 0 AS ID, 0 AS NO_S, 0 AS N_SERI, 0 AS BANK, 0 AS NUMBER, 0 AS TAG, ARZDS / TEDAD AS ARZD
