CREATE  FUNCTION [dbo].[Q_DAFTAR_TAFZIL_2_2]
...
 RETURN ( SELECT     TOP 100 PERCENT dbo.DEED_HED.N_S, dbo.DEED_HED.DATE_S, dbo.DEED_DTL.HES_K, dbo.DEED_DTL.HES_M, dbo.DEED_DTL.HES_T, dbo.DEED_DTL.HES_T2, 
                       dbo.DEED_DTL.SHARH, dbo.DEED_DTL.BED, dbo.DEED_DTL.BES, dbo.DEED_DTL.BED - dbo.DEED_DTL.BES AS MAND, dbo.TOTA_HES.NAME, 
                       dbo.DETA_HES.NAME AS MOIN, dbo.TDETA_HES.NAME AS TAFZIL, dbo.TDETA_HES2.NAME AS TAFZIL2, dbo.DEED_DTL.id
...
                       (dbo.DEED_DTL.HES_K = @Forms___F_MENU_KOL_MOIN_TAFZIL___HKOL) AND (dbo.DEED_DTL.HES_M = @Forms___F_MENU_KOL_MOIN_TAFZIL___HMOIN) 
...
 SELECT     NN, MaxOfDATE_S, HES_K, HES_M, HES_T, HES_T2, SHARH, dbo.UIIF(MAND, '>', 0, MAND, 0) AS BED, dbo.UIIF(MAND, '>', 0, 0, MAND * - 1) AS BES, MAND, NAME, 
                       MOIN, TAFZIL, TAFZIL2, 0 AS Expr1
 FROM         dbo.Q_DAFTAR_TAFMAND_2_2(@Forms___F_MENU_KOL_MOIN_TAFZIL___DT1, @Forms___F_MENU_KOL_MOIN_TAFZIL___HKOL, 
                       @Forms___F_MENU_KOL_MOIN_TAFZIL___HMOIN, @Forms___F_MENU_KOL_MOIN_TAFZIL___HTAF, @Forms___F_MENU_KOL_MOIN_TAFZIL___HTAF2) 
                       Q_DAFTAR_TAFMAND_2_2)
