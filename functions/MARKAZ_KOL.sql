CREATE  FUNCTION [dbo].[MARKAZ_KOL]
...
                       dbo.UIIF(SumOfBED - SumOfBES, '<', 0, (SumOfBED - SumOfBES) * - 1, 0) AS bes, HES_K, KOLNAME
 FROM         dbo.MARKAZ_SUB_KOL(@Forms___FMENU_TARAZ_4___DT1, @Forms___FMENU_TARAZ_4___DT2, @Forms___FMENU_TARAZ_4___SNDNUM1, 
                       @Forms___FMENU_TARAZ_4___SNDNUM2, @MARKAZ) MARKAZ_SUB_KOL
