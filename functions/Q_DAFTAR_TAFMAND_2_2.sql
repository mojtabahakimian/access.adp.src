CREATE FUNCTION [dbo].[Q_DAFTAR_TAFMAND_2_2]
...
                       dbo.DETA_HES.NAME AS MOIN, dbo.TDETA_HES.NAME AS TAFZIL, dbo.TDETA_HES2.NAME AS TAFZIL2, SUM(dbo.DEED_DTL.ARZD) AS ARZDS, 
                       COUNT(dbo.DEED_DTL.N_S) AS TEDAD
 FROM         dbo.TDETA_HES2 INNER JOIN
...
                       dbo.TOTA_HES ON dbo.DETA_HES.N_KOL = dbo.TOTA_HES.NUMBER ON dbo.TDETA_HES2.N_KOL = dbo.TDETA_HES.N_KOL AND 
                       dbo.TDETA_HES2.NUMBER = dbo.TDETA_HES.NUMBER AND dbo.TDETA_HES2.TNUMBER = dbo.TDETA_HES.TNUMBER INNER JOIN
...
 GROUP BY dbo.DEED_DTL.HES_K, dbo.DEED_DTL.HES_M, dbo.DEED_DTL.HES_T2, dbo.DEED_DTL.HES_T, dbo.TOTA_HES.NAME, dbo.DETA_HES.NAME, 
                       dbo.TDETA_HES.NAME, dbo.TDETA_HES2.NAME
