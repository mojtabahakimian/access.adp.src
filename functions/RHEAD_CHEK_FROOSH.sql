CREATE FUNCTION [dbo].[RHEAD_CHEK_FROOSH]
...
RETURN ( SELECT     dbo.HEAD_LST.NUMBER, dbo.HEAD_LST.TAG, dbo.HEAD_LST.ANBAR, dbo.HEAD_LST.NUMBER1, dbo.HEAD_LST.DATE_N, dbo.HEAD_LST.TAH, dbo.HEAD_LST.MAS, 
                      ...
                      dbo.HEAD_LST.MOIN_KHF, dbo.HEAD_LST.ANBARF, dbo.HEAD_LST.FNUMCO, SUM(ISNULL(dbo.PAY_GETD.MABL, 0)) AS mab, COUNT(dbo.PAY_GETD.MABL) 
                      AS CountOfMABL
...
HAVING      (dbo.HEAD_LST.TAG = 2) AND (dbo.HEAD_LST.CUST_NO = @Forms___F_MENU_KHFR___HMOIN) AND (dbo.HEAD_LST.DATE_N BETWEEN 
