CREATE FUNCTION [dbo].[Q_DAFTAR_TAFZIL]
...
RETURNS TABLE
AS
RETURN (SELECT     TOP 100 PERCENT dbo.DEED_HED.N_S, dbo.DEED_HED.DATE_S, dbo.DEED_DTL.HES_K, dbo.DEED_DTL.HES_M, dbo.DEED_DTL.HES_T, dbo.DEED_DTL.SHARH, 
                      dbo.DEED_DTL.BED, dbo.DEED_DTL.BES, dbo.DEED_DTL.BED - dbo.DEED_DTL.BES AS MAND, dbo.TOTA_HES.NAME, dbo.DETA_HES.NAME AS MOIN, 
                      dbo.TDETA_HES.NAME AS TAFZIL, dbo.DEED_DTL.id, dbo.DEED_DTL.NUMBER
...
WHERE     (dbo.DEED_HED.DATE_S BETWEEN @Forms___F_MENU_KOL_MOIN_TAFZIL___DT1 AND @Forms___F_MENU_KOL_MOIN_TAFZIL___DT2) AND 
                      ...
                      AND (dbo.DEED_DTL.HES_T = @Forms___F_MENU_KOL_MOIN_TAFZIL___HTAF)
...
SELECT     NN, MaxOfDATE_S, HES_K, HES_M, HES_T, SHARH, dbo.UIIF(MAND, '>', 0, MAND, 0) AS BED, dbo.UIIF(MAND, '>', 0, 0, MAND * - 1) AS BES, MAND, 
                      NAME, MOIN, TAFZIL, 0 AS Expr1, 0 AS Expr2
