...
    RETURN ( SELECT     TOP 100 PERCENT dbo.INVO_LST.CODE, SUM(dbo.INVO_LST.MEGHk) AS MEGHk, SUM(dbo.INVO_LST.MABL_K) AS MABL_K, 
...
                         dbo.STUF_DEF.NAME AS kala, dbo.CUST_HESAB.NAME AS VISITOR, dbo.VISITOR_DTL.CUST_NO, SUM(dbo.INVO_LST.MEGHk) AS MEGH_MAR, 
 
                         SUM(dbo.INVO_LST.MABL_K) AS MABMAR, SUM(dbo.INVO_LST.MABL_K + dbo.INVO_LST.IMBAA - dbo.INVO_LST.N_MOIN) AS GHABEL, 
