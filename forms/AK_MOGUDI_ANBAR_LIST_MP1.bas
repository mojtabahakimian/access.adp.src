...
Begin Form
    ...
    RecSrcDt = Begin
        0x79302806d104e540
    End
    RecordSource ="SELECT SUM(MAND) AS MANDS, col1, ANBAR, SUM(MANDF) AS MANDFS, ANBARN, NAMES FROM"
        " AKMOGUDI_KOL_ANBAR_N_FANI(999999, 5) AKMOGUDI_KOL_ANBAR_N_FANI GROUP BY ANBAR, "
        "ANBARN, NAMES, col1"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =5310
                    TabIndex =5
                    Name ="AK_MOGUDI_ANBAR_LIST_MP2"
                    SourceObject ="Form.AK_MOGUDI_ANBAR_LIST_MP2"
                    LinkChildFields ="col1"
                    LinkMasterFields ="col1"
                End
                Begin ComboBox
                    OldBorderStyle =0
                    OverlapFlags =85
...
End
CodeBehindForm
' See "AK_MOGUDI_ANBAR_LIST_MP1.cls"
