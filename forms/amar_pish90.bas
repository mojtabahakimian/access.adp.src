...
Begin Form
    ...
    RecSrcDt = Begin
        0xb05582e5dbbae540
    End
    RecordSource ="SELECT top(90) SUM(INVO_LST.MEGHk) AS MEGHT, SUM(INVO_LST.MABL_K - INVO_LST.N_MO"
        "IN) AS MABL_K, dbo.Uday(HEAD_LST.DATE_N) AS DD, dbo.Umonth(HEAD_LST.DATE_N) AS m"
        "m, HEAD_LST.DATE_N FROM HEAD_LST INNER JOIN INVO_LST ON HEAD_LST.NUMBER = INVO_L"
        "ST.NUMBER AND HEAD_LST.TAG = INVO_LST.TAG WHERE (HEAD_LST.TAG = 20) GROUP BY HEA"
        "D_LST.DATE_N, dbo.Uday(HEAD_LST.DATE_N), dbo.Umonth(HEAD_LST.DATE_N) ORDER BY HE"
        "AD_LST.DATE_N DESC"
    ...
    PivotTableXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:WorksheetOpt"
        ...
        ">\015\012   <x:LeftOffset>0</x:LeftOffset>\015\012   <x:SeqNum>493</x:SeqNum>\015"
    ...
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        ...
        "\012   <x:Color>#FFFF99</x:Color>\015\012   <x:FillEffect>\015\012    <x:fill x:"
        "type=\"Solid\" x:color=\"#FFFF99\"/>\015\012   </x:FillEffect>\015\012  </x:Inte"
        ...
        "nsion>\015\012      <x:ScaleID>197343252</x:ScaleID>\015\012      <x:Index>Categ"
        "ories</x:Index>\015\012     </x:Dimension>\015\012     <x:Dimension>\015\012    "
        "  <x:ScaleID>197343456</x:ScaleID>\015\012      <x:Index>Value</x:Index>\015\012"
        "     </x:Dimension>\015\012     <x:Dimension>\015\012      <x:ScaleID>197343660<"
        ...
        "\012    <x:Axis>\015\012     <x:AxisID>197347040</x:AxisID>\015\012     <x:Scale"
        "ID>197343252</x:ScaleID>\015\012     <x:Type>TimeScale</x:Type>\015\012     <x:F"
        ...
        "roupingEnum>\015\012    </x:Axis>\015\012    <x:Axis>\015\012     <x:AxisID>1973"
        "47748</x:AxisID>\015\012     <x:ScaleID>197343456</x:ScaleID>\015\012     <x:Typ"
        ...
        "\012    <x:Data>&quot; پيش فاکتورهاي 90 روزه&quot;</x:Data>\015\012   </x:Captio"
        "n>\015\012  </x:Title>\015\012  <x:Scaling>\015\012   <x:ScaleID>197343252</x:Sc"
        "aleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>197343456"
        "</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>197"
        "343660</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:HidePassiveAlert/>\015\012 "
