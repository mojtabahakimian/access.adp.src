...
Begin Form
    ...
    RecordSource ="SELECT SUM(MEGHKF) AS MEGHF, SUM(MABK) AS MABKK, SUM(MEGHkK) AS MEGHk, SAIZE, TA"
        "RH, CAST(TARH AS INT) AS TTARH FROM FROOSH_COUNTALL_CITY_N_FANI(1, 999999) FROOS"
        "H_COUNTALL_CITY_N_FANI GROUP BY SAIZE, TARH, CAST(TARH AS INT)"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =5310
                    TabIndex =1
                    Name ="FROOSH_COUNTALL_MP3"
                    SourceObject ="Form.FROOSH_COUNTALL_MP3"
                    LinkChildFields ="SAIZE;TARH"
                    LinkMasterFields ="SAIZE;TARH"
                    Begin
                        Begin Label
                            OverlapFlags =93
                            Left =3795
