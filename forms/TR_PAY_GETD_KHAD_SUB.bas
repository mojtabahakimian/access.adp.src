            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT DETA_HES.NUMBER, DETA_HES.NAME FROM DETA_HES WHERE (((DETA_HES.N_KOL)=[Fo"
                        "rms]![HEAD_LST_KHADAMAT]![PAY_GETD_KHAD_SUB].[Form]![N_KOL])) GROUP BY DETA_HES."
                        "NUMBER, DETA_HES.NAME ORDER BY DETA_HES.NAME;"
                    ColumnWidths ="0"
                    Begin
                        Begin Label
                            OverlapFlags =85
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT TDETA_HES.TNUMBER, TDETA_HES.NAME FROM TDETA_HES WHERE (((TDETA_HES.NUMBE"
                        "R)=[Forms]![HEAD_LST_KHADAMAT]![PAY_GETD_KHAD_SUB].[Form]![N_MOIN]) AND ((TDETA_"
                        "HES.N_KOL)=[Forms]![HEAD_LST_KHADAMAT]![PAY_GETD_KHAD_SUB].[Form]![N_KOL])) GROU"
                        "P BY TDETA_HES.TNUMBER, TDETA_HES.NAME ORDER BY TDETA_HES.NAME;"
                    ColumnWidths ="0"
                    Begin
                        Begin Label
                            OverlapFlags =215
