...
Begin Form
    ...
    RecSrcDt = Begin
        0x5168454cb4f0e540
    End
    RecordSource ="SELECT top(90) SUM(INVO_LST.MEGHk) AS MEGHT, dbo.Uday(HEAD_LST.DATE_N) AS dd, db"
        "o.Umonth(HEAD_LST.DATE_N) AS mm, SUM(INVO_LST.MABL_K - INVO_LST.N_MOIN) AS MABL_"
        "K, HEAD_LST.DATE_N FROM HEAD_LST INNER JOIN INVO_LST ON HEAD_LST.NUMBER = INVO_L"
        "ST.NUMBER AND HEAD_LST.TAG = INVO_LST.TAG WHERE (HEAD_LST.TAG = 2) AND (HEAD_LST"
        ".TAMIR = - 1) GROUP BY HEAD_LST.DATE_N, dbo.Uday(HEAD_LST.DATE_N), dbo.Umonth(HE"
        "AD_LST.DATE_N) ORDER BY HEAD_LST.DATE_N DESC"
    Caption ="فروش 7 روزه"
    ...
    PivotTableXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:WorksheetOpt"
        ...
        "on>\015\012   <x:EncodedType>adInteger</x:EncodedType>\015\012   <x:CompareOrder"
        "edMembersBy>UniqueName</x:CompareOrderedMembersBy>\015\012   <x:Expanded/>\015\012"
        ...
        ">\015\012   <x:Name>مبلغ كل</x:Name>\015\012   <x:SourceName>MABL_K</x:SourceNam"
        "e>\015\012   <x:DataType>Number</x:DataType>\015\012   <x:PLDataOrientation/>\015"
        ...
        "PivotField>\015\012   <x:Name>روز1</x:Name>\015\012   <x:SourceName>DATE_N</x:So"
        "urceName>\015\012   <x:DataType>Number</x:DataType>\015\012   <x:PLCaption>روز</"
        "x:PLCaption>\015\012   <x:FilterCaption>روز</x:FilterCaption>\015\012   <x:Encod"
        "edType>adBigInt</x:EncodedType>\015\012   <x:CompareOrderedMembersBy>UniqueName<"
        ...
        ">\015\012   <x:LeftOffset>0</x:LeftOffset>\015\012   <x:SeqNum>500</x:SeqNum>\015"
    ...
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        "\012  <x:OWCVersion>10.0.0.6854         </x:OWCVersion>\015\012  <x:Width>33761<"
        "/x:Width>\015\012  <x:Height>16166</x:Height>\015\012  <x:DisplayPropertyBrowser"
        ...
        "\012   <x:Color>#CCFFCC</x:Color>\015\012   <x:FillEffect>\015\012    <x:fill x:"
        "type=\"Solid\" x:color=\"#CCFFCC\"/>\015\012   </x:FillEffect>\015\012  </x:Inte"
        "rior>\015\012  <x:Chart>\015\012   <x:PlotArea>\015\012    <x:Interior>\015\012 "
        "    <x:Color>#FFFFFF</x:Color>\015\012     <x:FillEffect>\015\012      <x:fill x"
        ":type=\"Solid\" x:color=\"#FFFFFF\"/>\015\012     </x:FillEffect>\015\012    </x"
        ...
        "Index>\015\012       <x:Data>Total1</x:Data>\015\012      </x:Value>\015\012    "
        ...
        "      <x:Identifier>!</x:Identifier>\015\012     </x:Series>\015\012     <x:Dime"
        "nsion>\015\012      <x:ScaleID>293613448</x:ScaleID>\015\012      <x:Index>Categ"
        "ories</x:Index>\015\012     </x:Dimension>\015\012     <x:Dimension>\015\012    "
        "  <x:ScaleID>293613652</x:ScaleID>\015\012      <x:Index>Value</x:Index>\015\012"
        "     </x:Dimension>\015\012     <x:Dimension>\015\012      <x:ScaleID>293613856<"
        "/x:ScaleID>\015\012      <x:Index>FormatValue</x:Index>\015\012     </x:Dimensio"
        "n>\015\012     <x:Overlap>100</x:Overlap>\015\012     <x:GapWidth>150</x:GapWidt"
        "h>\015\012     <x:FirstSliceAngle>0</x:FirstSliceAngle>\015\012    </x:Graph>\015"
        "\012    <x:Axis>\015\012     <x:AxisID>293617236</x:AxisID>\015\012     <x:Scale"
        "ID>293613448</x:ScaleID>\015\012     <x:Type>TimeScale</x:Type>\015\012     <x:F"
        "ont>\015\012      <x:FontName>Tahoma</x:FontName>\015\012      <x:Size>7</x:Size"
        ">\015\012      <x:B>Automatic</x:B>\015\012      <x:I>Automatic</x:I>\015\012   "
        "   <x:U>Automatic</x:U>\015\012     </x:Font>\015\012     <x:Number>\015\012    "
        "  <x:FormatString>mm/dd/yy</x:FormatString>\015\012     </x:Number>\015\012     "
        "<x:Alignment>\015\012      <x:Rotation>0</x:Rotation>\015\012     </x:Alignment>"
        ...
        " <x:AxisID>293617944</x:AxisID>\015\012     <x:ScaleID>293613652</x:ScaleID>\015"
        "\012     <x:Type>Value</x:Type>\015\012     <x:Font>\015\012      <x:Size>7</x:S"
        "ize>\015\012      <x:B>Automatic</x:B>\015\012      <x:I>Automatic</x:I>\015\012"
        "      <x:U>Automatic</x:U>\015\012     </x:Font>\015\012     <x:Number>\015\012 "
        ...
        ":Size>7</x:Size>\015\012    <x:Color>#A52A2A</x:Color>\015\012    <x:B>Automatic"
        ...
        "aSourceIndex>\015\012    <x:Data>&quot;  مبلغ فروش90 روزه&quot;</x:Data>\015\012"
        "   </x:Caption>\015\012  </x:Title>\015\012  <x:Scaling>\015\012   <x:ScaleID>29"
        "3613448</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:Scal"
        "eID>293613652</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <"
        "x:ScaleID>293613856</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:HidePassiveAle"
