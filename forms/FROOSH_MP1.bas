...
Begin Form
    ...
    RecSrcDt = Begin
        0x1ae17737f152e540
    End
    RecordSource ="SELECT SUM(MABL_K) AS mabkk, col1, COUNT(CODE) AS cont FROM FROOSH_MP(1, 9999999"
        "9) FROOSH_MP GROUP BY col1 ORDER BY SUM(MABL_K) DESC"
