...
Begin Form
    ...
    RecSrcDt = Begin
        0x936b8056f22de440
    End
    ServerFilter ="number = 0"
    RecordSource ="RASID_KHARID"
    Caption ="فاكتور خريد"
                            ...
                            Begin
                                ...
                                Begin ComboBox
                                    ...
                                    RowSource ="SELECT NUMBER, TAG FROM HEAD_LST WHERE (TAG = 1) AND (NOT (NUMBER IN (SELECT HEA"
                                        "D_LST.NUMBER FROM HEAD_LST WHERE (((HEAD_LST.TAG) = 12))))) AND (SADER = 0 OR SA"
                                ...
                                Begin Subform
                                    ...
                                    SourceObject ="Form.INVO_LST_KH_SUB1"
                        ...
                        Begin Page
                            ...
                            Begin
                                ...
                                Begin ComboBox
                                    ...
                                    RowSourceType ="Table/View/StoredProc"
                                    RowSource ="SELECT hes, NAME FROM CUST_HESAB ORDER BY NAME, hes"
                                    ColumnWidths ="853"
                                    BeforeUpdate ="[Event Procedure]"
                                    OnExit ="[Event Procedure]"
                                    OnNotInList ="[Event Procedure]"
                                ...
                                Begin Subform
                                    ...
                                    TabIndex =10
                                    Name ="PAY_GETP_SUB"
                                    SourceObject ="Form.PAY_GETP_SUB"
                                    LinkChildFields ="NUMBER;TAG"
                                    LinkMasterFields ="NUMBER;DTAG"
                                    OnExit ="[Event Procedure]"
                                    Begin
                                ...
                                Begin TextBox
                                    ...
                                    TabIndex =11
                                    Name ="NPAR"
                                    ControlSource ="=[M_NAGHD]+[NCHK]+[MABL_HAV]+[MABL_VAR]"
                                    Format ="#,##0.00;-#,##0.00"
                                    Begin
                                        Begin Label
                                            OverlapFlags =255
                                ...
                                Begin ComboBox
                                    ...
                                    RowSourceType ="Table/View/StoredProc"
                                    RowSource ="SELECT hes, NAME, hes AS expr FROM CUST_HESAB ORDER BY NAME, hes"
                                    ColumnWidths ="853"
                                    Begin
                                        Begin Label
                                            OverlapFlags =247
