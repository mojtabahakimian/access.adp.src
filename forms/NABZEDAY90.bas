...
Begin Form
    ...
    RecSrcDt = Begin
        0x1c347f8599bae540
    End
    RecordSource ="SELECT TOP(90) COUNT(COMP_COD) AS CountOfCOMP_COD, STDATE, dbo.Uday(STDATE) AS D"
        "D, dbo.Umonth(STDATE) AS mm FROM TASKS GROUP BY STDATE, dbo.Uday(STDATE), dbo.Um"
        "onth(STDATE) ORDER BY STDATE DESC, COUNT(COMP_COD) DESC"
    Caption ="7 روزه"
    ...
    PivotTableXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:WorksheetOpt"
        ...
        ":PivotField>\015\012  <x:PivotField>\015\012   <x:Name>Data</x:Name>\015\012   <"
        ...
        "Name>Sum of مقدار</x:Name>\015\012   <x:PLName>Total1</x:PLName>\015\012   <x:To"
        "talNumber>0</x:TotalNumber>\015\012   <x:Orientation>Data</x:Orientation>\015\012"
        "   <x:Position>1</x:Position>\015\012   <x:ParentField>مقدار</x:ParentField>\015"
        "\012  </x:PivotField>\015\012  <x:PivotData>\015\012   <x:Top>0.0.0</x:Top>\015\012"
        "   <x:TopOffset>0</x:TopOffset>\015\012   <x:Left>0</x:Left>\015\012   <x:LeftOf"
        "fset>0</x:LeftOffset>\015\012   <x:SeqNum>307</x:SeqNum>\015\012  </x:PivotData>"
        "\015\012  <x:PivotView>\015\012   <x:IsNotFiltered/>\015\012   <x:Label>\015\012"
        "    <x:Caption>Microsoft Office PivotTable 10.0</x:Caption>\015\012    <x:NotVis"
        "ible/>\015\012   </x:Label>\015\012   <x:AllowEdits>false</x:AllowEdits>\015\012"
        "   <x:AllowAdditions>false</x:AllowAdditions>\015\012   <x:AllowDeletions>false<"
        "/x:AllowDeletions>\015\012  </x:PivotView>\015\012 </x:PivotTable>\015\012</xml>"
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        ...
        "x:SubType>Standard</x:SubType>\015\012     <x:Series>\015\012      <x:Border>\015"
        "\012       <x:Color>#1E90FF</x:Color>\015\012       <x:LineJoin>JoinMiter</x:Lin"
        "eJoin>\015\012      </x:Border>\015\012      <x:Line>\015\012       <x:Color>#00"
        "0000</x:Color>\015\012       <x:LineJoin>JoinRound</x:LineJoin>\015\012      </x"
        ":Line>\015\012      <x:Interior>\015\012       <x:Color>#1E90FF</x:Color>\015\012"
        "       <x:FillEffect>\015\012        <x:fill x:type=\"Solid\" x:color=\"#1E90FF\""
        "/>\015\012       </x:FillEffect>\015\012      </x:Interior>\015\012      <x:Form"
        "atMap>\015\012      </x:FormatMap>\015\012      <x:Name>Series</x:Name>\015\012 "
        "     <x:Caption>\015\012       <x:DataSourceIndex>-1</x:DataSourceIndex>\015\012"
        "       <x:Data>&quot;Series&quot;</x:Data>\015\012      </x:Caption>\015\012    "
        "  <x:Index>0</x:Index>\015\012      <x:Category>\015\012       <x:DataSourceInde"
        "x>0</x:DataSourceIndex>\015\012      </x:Category>\015\012      <x:Value>\015\012"
        ...
        ">\015\012      <x:Smooth/>\015\012      <x:DataSourceIndex>0</x:DataSourceIndex>"
        "\015\012      <x:Identifier>!.Sum of مقدار</x:Identifier>\015\012     </x:Series"
        ">\015\012     <x:Dimension>\015\012      <x:ScaleID>245910040</x:ScaleID>\015\012"
        "      <x:Index>Categories</x:Index>\015\012     </x:Dimension>\015\012     <x:Di"
        "mension>\015\012      <x:ScaleID>245910244</x:ScaleID>\015\012      <x:Index>Val"
        "ue</x:Index>\015\012     </x:Dimension>\015\012     <x:Dimension>\015\012      <"
        "x:ScaleID>245910448</x:ScaleID>\015\012      <x:Index>FormatValue</x:Index>\015\012"
        "     </x:Dimension>\015\012     <x:Overlap>100</x:Overlap>\015\012     <x:GapWid"
        "th>150</x:GapWidth>\015\012     <x:FirstSliceAngle>0</x:FirstSliceAngle>\015\012"
        "    </x:Graph>\015\012    <x:Axis>\015\012     <x:AxisID>245913872</x:AxisID>\015"
        "\012     <x:ScaleID>245910040</x:ScaleID>\015\012     <x:Type>TimeScale</x:Type>"
        "\015\012     <x:Font>\015\012      <x:FontName>Tahoma</x:FontName>\015\012      "
        "<x:Size>7</x:Size>\015\012      <x:B>Automatic</x:B>\015\012      <x:I>Automatic"
        "</x:I>\015\012      <x:U>Automatic</x:U>\015\012     </x:Font>\015\012     <x:Nu"
        "mber>\015\012      <x:FormatString>mm/dd/yy</x:FormatString>\015\012     </x:Num"
        "ber>\015\012     <x:MajorTick>Outside</x:MajorTick>\015\012     <x:MinorTick>Non"
        "e</x:MinorTick>\015\012     <x:Placement>Bottom</x:Placement>\015\012     <x:Gro"
        "upingEnum>Auto</x:GroupingEnum>\015\012    </x:Axis>\015\012    <x:Axis>\015\012"
        "     <x:AxisID>245914936</x:AxisID>\015\012     <x:ScaleID>245910244</x:ScaleID>"
        "\015\012     <x:Type>Value</x:Type>\015\012     <x:Number>\015\012      <x:Forma"
        "tString>General</x:FormatString>\015\012     </x:Number>\015\012     <x:MajorTic"
        "k>Outside</x:MajorTick>\015\012     <x:MinorTick>None</x:MinorTick>\015\012     "
        "<x:Placement>Left</x:Placement>\015\012    </x:Axis>\015\012   </x:PlotArea>\015"
        "\012   <x:Identifier></x:Identifier>\015\012  </x:Chart>\015\012  <x:Title>\015\012"
        "   <x:Font>\015\012    <x:FontName>B Titr</x:FontName>\015\012    <x:Size>7</x:S"
        "ize>\015\012    <x:Color>#DAA520</x:Color>\015\012    <x:B>Automatic</x:B>\015\012"
        ...
        "\012    <x:Data>&quot; فعاليتهاي 90روزه&quot;</x:Data>\015\012   </x:Caption>\015"
        "\012  </x:Title>\015\012  <x:Scaling>\015\012   <x:ScaleID>245910040</x:ScaleID>"
        "\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>245910244</x:Sc"
        "aleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>245910448"
