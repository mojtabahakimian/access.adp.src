...
Begin Form
    ...
    RecSrcDt = Begin
        0x433b6c90a7dee340
    End
    RecordSource ="SELECT HEAD_LST.* FROM HEAD_LST WHERE (TAG = 5) ORDER BY NUMBER"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    SourceObject ="Form.INVO_LST_ENTEGHAL_SUB"
                    LinkChildFields ="NUMBER;TAG;ANBAR;ANBARF"
                    LinkMasterFields ="NUMBER;htag;ANBAR;ANBARF"
