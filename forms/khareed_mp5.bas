...
Begin Form
    ...
    RecSrcDt = Begin
        0x81c52f996f64e540
    End
    RecordSource ="SELECT SUM(MABL_K) AS mabkk, col1,col2,col3,col4,col5, COUNT(CODE) AS cont FROM "
        "KHAREED_MP(1, 99999999) KHAREED_MP GROUP BY col1,col2,col3,col4,col5"
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ConditionalFormat = Begin
                        ...
                        0x0000000000ffff00000000000000000000000000000000000000000000000000 ,
                ...
                Begin Subform
                    ...
                    TabIndex =8
                    Name ="khareed_mp6"
                    SourceObject ="Form.khareed_mp6"
                    LinkChildFields ="col1;col2;col3;col4;col5"
                    LinkMasterFields ="col1;col2;col3;col4;col5"
                    Begin
                        Begin Label
                            OverlapFlags =93
                            Left =7515
                            ...
                            Width =930
                            Height =240
                            Name ="froosh_mp6 Label"
                            Caption ="froosh_mp6"
                            EventProcPrefix ="froosh_mp6_Label"
                        End
                    End
                End
            End
