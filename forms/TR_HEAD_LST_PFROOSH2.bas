...
Begin Form
    ...
    RecSrcDt = Begin
        0x2d48e5d1b2d8e540
    End
    RecordSource ="SELECT NUMBER, TAG AS htag, TAG AS DTAG, ANBAR, NUMBER1, DATE_N, TAH, MAS, VAS, "
        "N_S, CUST_NO, MOLAH, M_NAGHD, MABL_VAR, MOIN_VAR, MABL_HAV, MOIN_HAV, MABL_HAZ, "
        "MOIN_HAZ, TAKHFIF, MOIN_KHF, ANBARF, FNUMCO, DEPATMAN, SHIFT, CUST_KIND, USER_NA"
        "ME, SGN1, SGN2, SGN3, SGN4, MBAA, HMBAA, TAMIR, TICMBAA, TKHF, OKF, UP_TIME, UP_"
        "USER_NAME, PC_NAME, IPADD, TRIDD, SADER, ARZD, ARZKIND, CDDATE, CDTIME, OKDATE, "
        "OKTIME, JAY, MODAT_PPID, PEPID, PEID, UP_DATE, SHARAYET FROM TR_HEAD_LST WHERE ("
        "TAG = 20) ORDER BY NUMBER, UP_DATE, UP_TIME"
    Caption ="فاكتور فروش"
                        ...
                        Begin Page
                            ...
                            Begin
                                ...
                                Begin Subform
                                    ...
                                    LinkChildFields ="NUMBER;KIND;UP_DATE;UP_TIME"
