...
Begin Form
    ...
    RecSrcDt = Begin
        0xdcbdf08af152e540
    End
    RecordSource ="SELECT SUM(MABL_K) AS mabkk, col1,col2,col3,col4, COUNT(CODE) AS cont FROM FROOS"
        "H_MP(1, 99999999) FROOSH_MP GROUP BY col1,col2,col3,col4"
