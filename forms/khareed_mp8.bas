...
Begin Form
    ...
    RecSrcDt = Begin
        0x2fdede8f6f64e540
    End
    RecordSource ="SELECT SUM(MABL_K) AS mabkk, col1,col2,col3,col4,col5,col6,col7,col8, COUNT(CODE"
        ") AS cont FROM KHAREED_MP(1, 99999999) KHAREED_MP GROUP BY col1,col2,col3,col4,c"
        "ol5,col6,col7,col8"
                ...
                Begin Subform
                    ...
                    Begin
                        Begin Label
                            ...
                            Width =1095
                            Height =240
                            Name ="FROOSH_MP9 Label"
                            Caption ="FROOSH_MP9"
                            EventProcPrefix ="FROOSH_MP9_Label"
                        End
                    End
                End
            End
