            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT     DETA_HES.NUMBER, DETA_HES.NAME FROM DETA_HES WHERE     (((DETA_HES.N_"
                        "KOL) =112)) GROUP BY DETA_HES.NUMBER, DETA_HES.NAME ORDER BY DETA_HES.NAME"
                    ColumnWidths ="0"
                    AfterUpdate ="[Event Procedure]"
                    OnNotInList ="[Event Procedure]"
                    Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT TDETA_HES.TNUMBER, TDETA_HES.NAME FROM TDETA_HES WHERE (((TDETA_HES.NUMBE"
                        "R) =) AND ((TDETA_HES.N_KOL) =112))GROUP BY TDETA_HES.TNUMBER, TDETA_HES.NAME OR"
