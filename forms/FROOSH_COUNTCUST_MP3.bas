...
Begin Form
    ...
    RecordSource ="SELECT SUM(MEGHKF) AS MEGHF, SUM(MABK) AS MABKK, SUM(MEGHkK) AS MEGHk, SAIZE, TA"
        "RH, CAST(TARH AS INT) AS TTARH, DEGR, CUST_NO FROM FROOSH_COUNTALL_CITY_N_FANI(1"
        ", 999999) FROOSH_COUNTALL_CITY_N_FANI GROUP BY SAIZE, TARH, CAST(TARH AS INT), D"
        "EGR, CUST_NO"
    Caption ="فروش به تفكيك مشتري سايز  طرح و درجه"
    ...
    PivotTableXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:WorksheetOpt"
        ...
        ">\015\012   <x:Name>درجه</x:Name>\015\012   <x:SourceName>DEGR</x:SourceName>\015"
        "\012   <x:Orientation>Row</x:Orientation>\015\012   <x:EncodedType>adVarWChar</x"
        ...
        "d>\015\012   <x:Name>Data</x:Name>\015\012   <x:Orientation>Column</x:Orientatio"
        "n>\015\012   <x:Position>-1</x:Position>\015\012   <x:DataField/>\015\012  </x:P"
        "ivotField>\015\012  <x:PivotField>\015\012   <x:Name>Sum of كارتن</x:Name>\015\012"
        ...
        "   <x:ParentField>كارتن</x:ParentField>\015\012   <x:NumberFormat>Fixed</x:Numbe"
        "rFormat>\015\012  </x:PivotField>\015\012  <x:PivotData>\015\012   <x:Top>0.0</x"
        ":Top>\015\012   <x:TopOffset>0</x:TopOffset>\015\012   <x:Left>0</x:Left>\015\012"
        "   <x:LeftOffset>0</x:LeftOffset>\015\012   <x:SeqNum>47</x:SeqNum>\015\012  </x"
        ":PivotData>\015\012  <x:PivotView>\015\012   <x:IsNotFiltered/>\015\012   <x:Lab"
        "el>\015\012    <x:Caption>Microsoft Office PivotTable 10.0</x:Caption>\015\012  "
        "  <x:NotVisible/>\015\012   </x:Label>\015\012   <x:AllowEdits>false</x:AllowEdi"
        "ts>\015\012   <x:AllowAdditions>false</x:AllowAdditions>\015\012   <x:AllowDelet"
        "ions>false</x:AllowDeletions>\015\012  </x:PivotView>\015\012 </x:PivotTable>\015"
        "\012</xml>"
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        ...
        ">\015\012    <x:Axis>\015\012     <x:AxisID>372722868</x:AxisID>\015\012     <x:"
        "ScaleID>372718080</x:ScaleID>\015\012     <x:Type>Value</x:Type>\015\012     <x:"
        ...
        "  </x:Title>\015\012  <x:Scaling>\015\012   <x:ScaleID>372717876</x:ScaleID>\015"
        "\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>372718080</x:ScaleI"
        "D>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>372718284</x:"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Width =6801
                    TabIndex =1
                    Name ="FROOSH_COUNTCUST_MP4"
                    SourceObject ="Form.FROOSH_COUNTCUST_MP4"
                    LinkChildFields ="SAIZE;TARH;DEGR;CUST_NO"
                    LinkMasterFields ="SAIZE;TARH;DEGR;CUST_NO"
                End
                Begin TextBox
                ...
                Begin TextBox
                    ...
                    ConditionalFormat = Begin
                        ...
                        0x0000000000ccff00000000000000000000000000000000000000000000000000 ,
