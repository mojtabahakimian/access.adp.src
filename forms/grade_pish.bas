...
Begin Form
    ...
    RecordSource ="SELECT SUM(INVO_LST.MABL_K - INVO_LST.N_MOIN + INVO_LST.IMBAA) AS GMAB, HEAD_LST"
        ...
        "INVO_LST.TAG WHERE (HEAD_LST.TAG = 20) AND (HEAD_LST.TAMIR <> 2) AND (HEAD_LST.T"
        "AMIR <> 3) AND (HEAD_LST.SGN1 = 1) and   (HEAD_LST.CUST_NO = N'112-1-92') GROUP "
        "BY HEAD_LST.NUMBER, HEAD_LST.DATE_N, HEAD_LST.CUST_NO, HEAD_LST.MOLAH, HEAD_LST."
        "DEPATMAN, HEAD_LST.SHIFT, HEAD_LST.CUST_KIND, HEAD_LST.USER_NAME, HEAD_LST.TAMIR"
