...
Begin Form
    ...
    RecSrcDt = Begin
        0xec34ab74b4f0e540
    End
    RecordSource ="SELECT TOP(30) STDATE AS STDATE, COUNT(IDD) AS IDC, dbo.Uday(STDATE) AS DD, dbo."
    ...
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        ...
        "  <x:Dimension>\015\012      <x:ScaleID>515455004</x:ScaleID>\015\012      <x:In"
        "dex>Categories</x:Index>\015\012     </x:Dimension>\015\012     <x:Dimension>\015"
        "\012      <x:ScaleID>515455208</x:ScaleID>\015\012      <x:Index>Value</x:Index>"
        "\015\012     </x:Dimension>\015\012     <x:Dimension>\015\012      <x:ScaleID>51"
        "5455412</x:ScaleID>\015\012      <x:Index>FormatValue</x:Index>\015\012     </x:"
        ...
        "raph>\015\012    <x:Axis>\015\012     <x:AxisID>515458792</x:AxisID>\015\012    "
        " <x:ScaleID>515455004</x:ScaleID>\015\012     <x:Type>Category</x:Type>\015\012 "
        "    <x:Font>\015\012      <x:FontName>Tahoma</x:FontName>\015\012      <x:Size>7"
        "</x:Size>\015\012      <x:B>Automatic</x:B>\015\012      <x:I>Automatic</x:I>\015"
        ...
        "\012    </x:Axis>\015\012    <x:Axis>\015\012     <x:AxisID>515459500</x:AxisID>"
        "\015\012     <x:ScaleID>515455208</x:ScaleID>\015\012     <x:Type>Value</x:Type>"
        ...
        " جزء 30 روزه&quot;</x:Data>\015\012   </x:Caption>\015\012  </x:Title>\015\012  "
        "<x:Scaling>\015\012   <x:ScaleID>515455004</x:ScaleID>\015\012  </x:Scaling>\015"
        "\012  <x:Scaling>\015\012   <x:ScaleID>515455208</x:ScaleID>\015\012  </x:Scalin"
        "g>\015\012  <x:Scaling>\015\012   <x:ScaleID>515455412</x:ScaleID>\015\012  </x:"
