...
Begin Form
    ...
    OrderBy ="HEAD_LST.NUMBER1"
    RecSrcDt = Begin
        0x8067198dcb02e340
    End
    ServerFilter ="TAG=22"
    RecordSource ="HEAD_LST"
    Caption ="فاكتور برگشت ازفروش سال قبل"
                        ...
                        Begin Page
                            ...
                            Begin
                                ...
                                Begin ComboBox
                                    ...
                                    Begin
                                        Begin Label
                                            ...
                                            Height =240
                                            Name ="Label104"
                                            Caption ="شماره حواله انبار سال قبل:"
                                        End
                                    End
                                End
                                Begin TextBox
                                ...
                                Begin Subform
                                    ...
                                    Height =4275
                                    TabIndex =6
                                    Name ="INVO_LST_BACK_SUBO"
                                    SourceObject ="Form.INVO_LST_BACK_SUBO2"
                                ...
                                Begin TextBox
                                    ...
                                    TabIndex =8
                                    Name ="Text59"
                                    ControlSource ="=[INVO_LST_BACK_SUBO].[Form]![SMABLK]"
                                ...
                                Begin TextBox
                                    ...
                                    TabIndex =13
                                    Name ="TEDADM"
                                    ControlSource ="=[INVO_LST_BACK_subO].[Form]![MEGHMAR]"
                                    Begin
                                        Begin Label
                                            OverlapFlags =215
                                            TextFontCharSet =0
...
End
CodeBehindForm
' See "HEAD_LST_FROOSH_BACKO2.cls"
