...
Begin Form
    ...
    RecSrcDt = Begin
        0xf7065f484e9fe240
    End
    Caption ="عملكرد هر ويزيتور به تفكيك ماه و گروه  كالا"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =8100
                    TabIndex =1
                    Name ="VISITOR_GOL_DTL_GRP_REP"
                    SourceObject ="Form.VISITOR_GOL_DTL_GRP_REP_mar"
                End
                Begin ComboBox
...
End
CodeBehindForm
' See "VISITOR_GOL_GRP_REP_MAR.cls"
