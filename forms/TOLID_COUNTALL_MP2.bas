...
Begin Form
    ...
    RecordSource ="SELECT SUM(MEGHT) AS MEGHk, SAIZE, SUM(MEGHKF) AS MEGHF, TARH, CAST(TARH AS INT)"
        " AS TTARH FROM AMAR_TOLID_FAREE(1, 9999999) AMAR_TOLID_FAREE GROUP BY SAIZE, TAR"
        "H, CAST(TARH AS INT)"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =5310
                    TabIndex =1
                    Name ="TOLID_COUNTALL_MP3"
                    SourceObject ="Form.TOLID_COUNTALL_MP3"
