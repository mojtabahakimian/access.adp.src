...
Begin Form
    ...
    RecordSource ="SELECT HEAD_LST.NUMBER, HEAD_LST.TAG, HEAD_LST.DATE_N, HEAD_LST.TAH, INVO_LST.AN"
        ...
        "IS.RADAH AND HEAD_LST.NUMBER = MEGH_RAIS.NUMBER1 WHERE (HEAD_LST.TAG = 23) ORDER"
        " BY HEAD_LST.NUMBER DESC"
    Caption ="ليست وضعيت درخواستهاي خريد بر اساس كالاها"
