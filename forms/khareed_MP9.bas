...
Begin Form
    ...
    RecSrcDt = Begin
        0xb06479926f64e540
    End
    RecordSource ="SELECT SUM(MABL_K) AS mabkk, col1,col2,col3,col4,col5,col6,col7,col8,col9, COUNT"
        "(CODE) AS cont FROM KHAREED_MP(1, 99999999) KHAREED_MP GROUP BY col1,col2,col3,c"
        "ol4,col5,col6,col7,col8,col9"
