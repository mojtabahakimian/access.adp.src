...
Begin Form
    ...
    RecordSource ="SELECT SUM(FROOSH_COUNTALL_CITY_N_FANI.MEGHKF) AS MEGHF, SUM(FROOSH_COUNTALL_CIT"
        ...
        "H_COUNTALL_CITY_N_FANI.CUST_NO, CUST_HESAB.NAME FROM FROOSH_COUNTALL_CITY_N_FANI"
        "(1, 999999) FROOSH_COUNTALL_CITY_N_FANI INNER JOIN CUST_HESAB ON FROOSH_COUNTALL"
        "_CITY_N_FANI.CUST_NO = CUST_HESAB.hes GROUP BY FROOSH_COUNTALL_CITY_N_FANI.CUST_"
        "NO, CUST_HESAB.NAME ORDER BY SUM(FROOSH_COUNTALL_CITY_N_FANI.MEGHkK) DESC"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =3401
                    TabIndex =4
                    Name ="FROOSH_COUNTCUST_MP1"
                    SourceObject ="Form.FROOSH_COUNTCUST_MP1"
