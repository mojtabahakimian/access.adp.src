...
Begin Form
    ...
    RecSrcDt = Begin
        0xdca876bdbeb8e540
    End
    RecordSource ="SELECT TOP(7) SUM(INVO_LST.MEGHk) AS MEGHT, SUM(INVO_LST.MABL_K - INVO_LST.N_MOI"
        "N) AS MABL_K, dbo.Uday(HEAD_LST.DATE_N) AS DD, HEAD_LST.DATE_N FROM HEAD_LST INN"
        "ER JOIN INVO_LST ON HEAD_LST.NUMBER = INVO_LST.NUMBER AND HEAD_LST.TAG = INVO_LS"
        "T.TAG WHERE (HEAD_LST.TAG = 20) GROUP BY HEAD_LST.DATE_N, dbo.Uday(HEAD_LST.DATE"
        "_N) ORDER BY HEAD_LST.DATE_N DESC"
    ...
    PivotTableXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:WorksheetOpt"
        ...
        "/x:DataType>\015\012   <x:Orientation>Row</x:Orientation>\015\012   <x:EncodedTy"
        "pe>adInteger</x:EncodedType>\015\012   <x:CompareOrderedMembersBy>UniqueName</x:"
        "CompareOrderedMembersBy>\015\012   <x:Expanded/>\015\012  </x:PivotField>\015\012"
        ...
        "\012   <x:LeftOffset>0</x:LeftOffset>\015\012   <x:SeqNum>497</x:SeqNum>\015\012"
    ...
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        ...
        "leID>245909984</x:ScaleID>\015\012      <x:Index>Categories</x:Index>\015\012   "
        "  </x:Dimension>\015\012     <x:Dimension>\015\012      <x:ScaleID>245910188</x:"
        "ScaleID>\015\012      <x:Index>Value</x:Index>\015\012     </x:Dimension>\015\012"
        "     <x:Dimension>\015\012      <x:ScaleID>245910392</x:ScaleID>\015\012      <x"
        ...
        "   <x:AxisID>245916664</x:AxisID>\015\012     <x:ScaleID>245909984</x:ScaleID>\015"
        ...
        "s>\015\012     <x:AxisID>307442696</x:AxisID>\015\012     <x:ScaleID>245910188</"
        "x:ScaleID>\015\012     <x:Type>Value</x:Type>\015\012     <x:Number>\015\012    "
        "  <x:FormatString>#,###</x:FormatString>\015\012     </x:Number>\015\012     <x:"
        "MajorTick>Outside</x:MajorTick>\015\012     <x:MinorTick>None</x:MinorTick>\015\012"
        ...
        "\015\012   <x:Font>\015\012    <x:FontName>B Titr</x:FontName>\015\012    <x:Siz"
        "e>7</x:Size>\015\012    <x:Color>#A52A2A</x:Color>\015\012    <x:B>Automatic</x:"
        "B>\015\012    <x:I>Automatic</x:I>\015\012    <x:U>Automatic</x:U>\015\012   </x"
        ...
        "rceIndex>\015\012    <x:Data>&quot; پيش فاکتورهاي 7 روزه&quot;</x:Data>\015\012 "
        "  </x:Caption>\015\012  </x:Title>\015\012  <x:Scaling>\015\012   <x:ScaleID>245"
        "909984</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:Scale"
        "ID>245910188</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x"
        ":ScaleID>245910392</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:HidePassiveAler"
        "t/>\015\012  <x:HideScreenTips/>\015\012 </x:ChartSpace>\015\012</xml>"
    AllowFormView =0
