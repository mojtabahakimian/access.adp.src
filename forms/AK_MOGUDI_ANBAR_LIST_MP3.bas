...
Begin Form
    ...
    RecordSource ="SELECT SUM(MAND) AS MANDS, col1, ANBAR, SUM(MANDF) AS MANDFS, ANBARN, NAMES, col"
        "2, col3 FROM AKMOGUDI_KOL_ANBAR_N_FANI(999999, 1) AKMOGUDI_KOL_ANBAR_N_FANI GROU"
        "P BY col1, ANBAR, ANBARN, NAMES, col2, col3"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Width =5556
                    TabIndex =7
                    Name ="AK_MOGUDI_ANBAR_LIST_MP4"
                    SourceObject ="Form.AK_MOGUDI_ANBAR_LIST_MP4"
...
End
CodeBehindForm
' See "AK_MOGUDI_ANBAR_LIST_MP3.cls"
