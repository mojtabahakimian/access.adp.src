...
Begin Form
    ...
    RecSrcDt = Begin
        0x0d58fca26f64e540
    End
    RecordSource ="SELECT SUM(MABL_K) AS mabkk, col1,col2,col3,col4, COUNT(CODE) AS cont FROM KHARE"
        "ED_MP(1, 99999999) KHAREED_MP GROUP BY col1,col2,col3,col4"
                ...
                Begin Subform
                    ...
                    Begin
                        Begin Label
                            ...
                            Width =930
                            Height =240
                            Name ="froosh_mp5 Label"
                            Caption ="froosh_mp5"
                            EventProcPrefix ="froosh_mp5_Label"
                        End
                    End
                End
            End
