        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    SourceObject ="Form.INVO_LST_HAVL_SUB"
                ...
                Begin ComboBox
                    ...
                    ControlSource ="MAS"
                    RowSourceType ="Table/View/StoredProc"
                    RowSource ="SELECT TCOD_CITY.CITYCODE, TCOD_CITY.CITYNAME + N' - ' + TCOD_OSTAN.OSNAME AS Ex"
                        "pr1 FROM TCOD_CITY INNER JOIN TCOD_OSTAN ON TCOD_CITY.OSCODE = TCOD_OSTAN.OSCODE"
                        " ORDER BY TCOD_CITY.OSCODE, TCOD_CITY.CITYCODE"
                    ColumnWidths ="0"
                    OnDblClick ="[Event Procedure]"
                    OnNotInList ="[Event Procedure]"
                    Begin
