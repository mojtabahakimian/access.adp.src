...
Begin Form
    ...
    RecSrcDt = Begin
        0xa29c4179f152e540
    End
    RecordSource ="SELECT SUM(MABL_K) AS mabkk, col1, col2, COUNT(CODE) AS cont FROM FROOSH_MP(1, 9"
        "9999999) FROOSH_MP GROUP BY col1, col2"
                ...
                Begin Subform
                    ...
                    Begin
                        Begin Label
                            ...
                            Width =930
                            Height =240
                            Name ="froosh_mp3 Label"
                            Caption ="froosh_mp3"
                            EventProcPrefix ="froosh_mp3_Label"
                        End
                    End
                End
            End
