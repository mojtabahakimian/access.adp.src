...
Begin Form
    ...
    RecSrcDt = Begin
        0x4a5de3a9dbbae540
    End
    RecordSource ="SELECT TOP(7) SUM(MABL) AS MAB, dbo.Uday(DATE) AS dd, dbo.Umonth(DATE) AS mm, DA"
        "TE FROM PAY_GETD GROUP BY dbo.Uday(DATE), dbo.Umonth(DATE), DATE ORDER BY DATE D"
        "ESC"
    Caption ="مبلغ نقدي"
    ...
    PivotTableXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:WorksheetOpt"
        ...
        "tOffset>\015\012   <x:SeqNum>692</x:SeqNum>\015\012  </x:PivotData>\015\012  <x:"
    ...
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        ...
        "/x:Width>\015\012  <x:Height>19050</x:Height>\015\012  <x:DisplayPropertyBrowser"
        ...
        "\012  </x:Border>\015\012  <x:Interior>\015\012   <x:Color>#FF9900</x:Color>\015"
        "\012   <x:FillEffect>\015\012    <x:fill x:type=\"Solid\" x:color=\"#FF9900\"/>\015"
        "\012   </x:FillEffect>\015\012  </x:Interior>\015\012  <x:Chart>\015\012   <x:Pl"
        "otArea>\015\012    <x:Interior>\015\012     <x:Color>#FFE4B5</x:Color>\015\012  "
        "   <x:FillEffect>\015\012      <x:fill x:type=\"Solid\" x:color=\"#FFE4B5\"/>\015"
        "\012     </x:FillEffect>\015\012    </x:Interior>\015\012    <x:Graph>\015\012  "
        "   <x:SubType>Smooth</x:SubType>\015\012     <x:Type>Line</x:Type>\015\012     <"
        "x:SubType>Standard</x:SubType>\015\012     <x:Series>\015\012      <x:FormatMap>"
        ...
        "<x:Marker>\015\012       <x:Symbol>None</x:Symbol>\015\012      </x:Marker>\015\012"
        "      <x:Explode>0</x:Explode>\015\012      <x:Thickness>10</x:Thickness>\015\012"
        "      <x:Smooth/>\015\012      <x:DataSourceIndex>0</x:DataSourceIndex>\015\012 "
        "     <x:Identifier>!.Sum of مبلغ كل</x:Identifier>\015\012     </x:Series>\015\012"
        "     <x:Dimension>\015\012      <x:ScaleID>259795328</x:ScaleID>\015\012      <x"
        ":Index>Categories</x:Index>\015\012     </x:Dimension>\015\012     <x:Dimension>"
        "\015\012      <x:ScaleID>259795532</x:ScaleID>\015\012      <x:Index>Value</x:In"
        "dex>\015\012     </x:Dimension>\015\012     <x:Dimension>\015\012      <x:ScaleI"
        "D>259795736</x:ScaleID>\015\012      <x:Index>FormatValue</x:Index>\015\012     "
        ...
        "/x:Graph>\015\012    <x:Axis>\015\012     <x:AxisID>259799208</x:AxisID>\015\012"
        "     <x:ScaleID>259795328</x:ScaleID>\015\012     <x:Type>TimeScale</x:Type>\015"
        "\012     <x:Font>\015\012      <x:FontName>Tahoma</x:FontName>\015\012      <x:S"
        "ize>7</x:Size>\015\012      <x:B>Automatic</x:B>\015\012      <x:I>Automatic</x:"
        "I>\015\012      <x:U>Automatic</x:U>\015\012     </x:Font>\015\012     <x:Number"
        ">\015\012      <x:FormatString>mm/dd/yy</x:FormatString>\015\012     </x:Number>"
        "\015\012     <x:Alignment>\015\012      <x:Rotation>90</x:Rotation>\015\012     "
        "</x:Alignment>\015\012     <x:MajorTick>Outside</x:MajorTick>\015\012     <x:Min"
        "orTick>Inside</x:MinorTick>\015\012     <x:Placement>Bottom</x:Placement>\015\012"
        "     <x:GroupingEnum>Auto</x:GroupingEnum>\015\012    </x:Axis>\015\012    <x:Ax"
        "is>\015\012     <x:AxisID>259799916</x:AxisID>\015\012     <x:ScaleID>259795532<"
        "/x:ScaleID>\015\012     <x:Type>Value</x:Type>\015\012     <x:Font>\015\012     "
        " <x:Size>7</x:Size>\015\012      <x:B>Automatic</x:B>\015\012      <x:I>Automati"
        "c</x:I>\015\012      <x:U>Automatic</x:U>\015\012     </x:Font>\015\012     <x:N"
        "umber>\015\012      <x:FormatString>#,###</x:FormatString>\015\012     </x:Numbe"
        "r>\015\012     <x:MajorTick>Outside</x:MajorTick>\015\012     <x:MinorTick>None<"
        "/x:MinorTick>\015\012     <x:Placement>Left</x:Placement>\015\012    </x:Axis>\015"
        "\012   </x:PlotArea>\015\012   <x:Identifier></x:Identifier>\015\012  </x:Chart>"
        "\015\012  <x:Title>\015\012   <x:Font>\015\012    <x:FontName>B Titr</x:FontName"
        ">\015\012    <x:Size>8</x:Size>\015\012    <x:Color>#A52A2A</x:Color>\015\012   "
        ...
        "ColorIndex>\015\012   </x:Border>\015\012   <x:Caption>\015\012    <x:DataSource"
        "Index>-1</x:DataSourceIndex>\015\012    <x:Data>&quot;مبلغ  چکهاي دريافتي7 روزه&"
        "quot;</x:Data>\015\012   </x:Caption>\015\012  </x:Title>\015\012  <x:Scaling>\015"
        "\012   <x:ScaleID>259795328</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scalin"
        "g>\015\012   <x:ScaleID>259795532</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:"
        "Scaling>\015\012   <x:ScaleID>259795736</x:ScaleID>\015\012  </x:Scaling>\015\012"
