...
Begin Form
    ...
    RecSrcDt = Begin
        0x7d7fab74b4f0e540
    End
    RecordSource ="SELECT TOP(90) STDATE AS STDATE, COUNT(IDD) AS IDC, dbo.Uday(STDATE) AS DD, dbo."
        "Umonth(STDATE) AS mm FROM EVENTS GROUP BY dbo.Uday(STDATE), STDATE, dbo.Umonth(S"
        "TDATE) ORDER BY STDATE DESC"
    Caption ="7 روزه"
    ...
    PivotTableXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:WorksheetOpt"
        ...
        "ition>2</x:Position>\015\012   <x:EncodedType>adInteger</x:EncodedType>\015\012 "
        "  <x:CompareOrderedMembersBy>UniqueName</x:CompareOrderedMembersBy>\015\012   <x"
        ":Expanded/>\015\012  </x:PivotField>\015\012  <x:PivotField>\015\012   <x:Name>م"
        "اه</x:Name>\015\012   <x:SourceName>mm</x:SourceName>\015\012   <x:DataType>Inte"
        "ger</x:DataType>\015\012   <x:Orientation>Row</x:Orientation>\015\012   <x:Encod"
        "edType>adInteger</x:EncodedType>\015\012   <x:CompareOrderedMembersBy>UniqueName"
        "</x:CompareOrderedMembersBy>\015\012   <x:Expanded/>\015\012  </x:PivotField>\015"
        ...
        "\015\012   <x:Top>0.0.0</x:Top>\015\012   <x:TopOffset>0</x:TopOffset>\015\012  "
        " <x:Left>0</x:Left>\015\012   <x:LeftOffset>0</x:LeftOffset>\015\012   <x:SeqNum"
        ">380</x:SeqNum>\015\012  </x:PivotData>\015\012  <x:PivotView>\015\012   <x:IsNo"
        "tFiltered/>\015\012   <x:Label>\015\012    <x:Caption>Microsoft Office PivotTabl"
        "e 10.0</x:Caption>\015\012    <x:NotVisible/>\015\012   </x:Label>\015\012   <x:"
        "AllowEdits>false</x:AllowEdits>\015\012   <x:AllowAdditions>false</x:AllowAdditi"
        "ons>\015\012   <x:AllowDeletions>false</x:AllowDeletions>\015\012  </x:PivotView"
        ">\015\012 </x:PivotTable>\015\012</xml>"
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        ...
        "  </x:Border>\015\012  <x:Interior>\015\012   <x:Color>#339966</x:Color>\015\012"
        "   <x:FillEffect>\015\012    <x:fill x:type=\"Solid\" x:color=\"#339966\"/>\015\012"
        "   </x:FillEffect>\015\012  </x:Interior>\015\012  <x:Chart>\015\012   <x:PlotAr"
        "ea>\015\012    <x:Interior>\015\012     <x:Color>#ADD8E6</x:Color>\015\012     <"
        "x:FillEffect>\015\012      <x:fill x:type=\"Solid\" x:color=\"#ADD8E6\"/>\015\012"
        ...
        "      <x:Color>#000000</x:Color>\015\012       <x:LineJoin>JoinRound</x:LineJoin"
        ">\015\012      </x:Line>\015\012      <x:FormatMap>\015\012      </x:FormatMap>\015"
        ...
        "s>\015\012      <x:Smooth/>\015\012      <x:DataSourceIndex>0</x:DataSourceIndex"
        ">\015\012      <x:Identifier>!</x:Identifier>\015\012     </x:Series>\015\012   "
        "  <x:Dimension>\015\012      <x:ScaleID>245909800</x:ScaleID>\015\012      <x:In"
        "dex>Categories</x:Index>\015\012     </x:Dimension>\015\012     <x:Dimension>\015"
        "\012      <x:ScaleID>245910004</x:ScaleID>\015\012      <x:Index>Value</x:Index>"
        "\015\012     </x:Dimension>\015\012     <x:Dimension>\015\012      <x:ScaleID>24"
        "5910208</x:ScaleID>\015\012      <x:Index>FormatValue</x:Index>\015\012     </x:"
        ...
        "raph>\015\012    <x:Axis>\015\012     <x:AxisID>245913096</x:AxisID>\015\012    "
        " <x:ScaleID>245909800</x:ScaleID>\015\012     <x:Type>TimeScale</x:Type>\015\012"
        ...
        "\012      <x:U>Automatic</x:U>\015\012     </x:Font>\015\012     <x:Number>\015\012"
        "      <x:FormatString>mm/dd/yy</x:FormatString>\015\012     </x:Number>\015\012 "
        "    <x:MajorTick>Outside</x:MajorTick>\015\012     <x:MinorTick>None</x:MinorTic"
        "k>\015\012     <x:Placement>Bottom</x:Placement>\015\012     <x:GroupingEnum>Aut"
        "o</x:GroupingEnum>\015\012    </x:Axis>\015\012    <x:Axis>\015\012     <x:AxisI"
        "D>245915516</x:AxisID>\015\012     <x:ScaleID>245910004</x:ScaleID>\015\012     "
        "<x:Type>Value</x:Type>\015\012     <x:Number>\015\012      <x:FormatString>Gener"
        "al</x:FormatString>\015\012     </x:Number>\015\012     <x:MajorTick>Outside</x:"
        "MajorTick>\015\012     <x:MinorTick>None</x:MinorTick>\015\012     <x:Placement>"
        "Left</x:Placement>\015\012    </x:Axis>\015\012   </x:PlotArea>\015\012   <x:Ide"
        "ntifier></x:Identifier>\015\012  </x:Chart>\015\012  <x:Title>\015\012   <x:Font"
        ">\015\012    <x:FontName>B Titr</x:FontName>\015\012    <x:Size>7</x:Size>\015\012"
        "    <x:Color>#FFA500</x:Color>\015\012    <x:B>Automatic</x:B>\015\012    <x:I>A"
        "utomatic</x:I>\015\012    <x:U>Automatic</x:U>\015\012   </x:Font>\015\012   <x:"
        "Border>\015\012    <x:ColorIndex>None</x:ColorIndex>\015\012   </x:Border>\015\012"
        "   <x:Caption>\015\012    <x:DataSourceIndex>-1</x:DataSourceIndex>\015\012    <"
        "x:Data>&quot; فعاليتهاي جزء 90روزه&quot;</x:Data>\015\012   </x:Caption>\015\012"
        "  </x:Title>\015\012  <x:Scaling>\015\012   <x:ScaleID>245909800</x:ScaleID>\015"
        "\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>245910004</x:ScaleI"
        "D>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>245910208</x:"
