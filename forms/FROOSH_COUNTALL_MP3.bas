...
Begin Form
    ...
    RecordSource ="SELECT SUM(MEGHKF) AS MEGHF, SUM(MABK) AS MABKK, SUM(MEGHkK) AS MEGHk, SAIZE, TA"
        "RH, CAST(TARH AS INT) AS TTARH, DEGR FROM FROOSH_COUNTALL_CITY_N_FANI(1, 999999)"
        " FROOSH_COUNTALL_CITY_N_FANI GROUP BY SAIZE, TARH, CAST(TARH AS INT), DEGR"
    Caption ="فروش به تفكيك سايز  طرح و درجه"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Width =5556
                    TabIndex =1
                    Name ="FROOSH_COUNTALL_MP4"
                    SourceObject ="Form.FROOSH_COUNTALL_MP4"
                    LinkChildFields ="SAIZE;TARH;DEGR"
                    LinkMasterFields ="SAIZE;TARH;DEGR"
                End
                Begin TextBox
