...
Begin Form
    ...
    RecordSource ="SELECT SUM(MEGHT) AS MEGHk, SAIZE, SUM(MEGHKF) AS MEGHF, TARH, CAST(TARH AS INT)"
        " AS TTARH, DEGR FROM AMAR_TOLID_FAREE(1, 9999999) AMAR_TOLID_FAREE GROUP BY SAIZ"
        "E, TARH, CAST(TARH AS INT), DEGR"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Width =5556
                    TabIndex =1
                    Name ="TOLID_COUNTALL_MP4"
                    SourceObject ="Form.TOLID_COUNTALL_MP4"
