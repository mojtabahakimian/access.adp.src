...
Begin Form
    ...
    RecSrcDt = Begin
        0x3187de8f6f64e540
    End
    RecordSource ="SELECT SUM(MABL_K) AS mabkk, col1,col2,col3,col4,col5,col6, COUNT(CODE) AS cont "
        "FROM KHAREED_MP(1, 99999999) KHAREED_MP GROUP BY col1,col2,col3,col4,col5,col6"
                ...
                Begin Subform
                    ...
                    Begin
                        Begin Label
                            ...
                            Width =1095
                            Height =240
                            Name ="FROOSH_MP7 Label"
                            Caption ="FROOSH_MP7"
                            EventProcPrefix ="FROOSH_MP7_Label"
                        End
                    End
                End
            End
