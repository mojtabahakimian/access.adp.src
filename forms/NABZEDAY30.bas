...
Begin Form
    ...
    RecSrcDt = Begin
        0x3535599ad2bbe540
    End
    RecordSource ="SELECT TOP(30) COUNT(COMP_COD) AS CountOfCOMP_COD, STDATE, dbo.Uday(STDATE) AS D"
    ...
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        ...
        "     <x:Dimension>\015\012      <x:ScaleID>515455100</x:ScaleID>\015\012      <x"
        ":Index>Categories</x:Index>\015\012     </x:Dimension>\015\012     <x:Dimension>"
        "\015\012      <x:ScaleID>515455304</x:ScaleID>\015\012      <x:Index>Value</x:In"
        "dex>\015\012     </x:Dimension>\015\012     <x:Dimension>\015\012      <x:ScaleI"
        "D>515455508</x:ScaleID>\015\012      <x:Index>FormatValue</x:Index>\015\012     "
        ...
        "/x:Graph>\015\012    <x:Axis>\015\012     <x:AxisID>515458932</x:AxisID>\015\012"
        "     <x:ScaleID>515455100</x:ScaleID>\015\012     <x:Type>TimeScale</x:Type>\015"
        ...
        " <x:AxisID>515459640</x:AxisID>\015\012     <x:ScaleID>515455304</x:ScaleID>\015"
        "\012     <x:Type>Value</x:Type>\015\012     <x:Number>\015\012      <x:FormatStr"
        "ing>General</x:FormatString>\015\012     </x:Number>\015\012     <x:MajorTick>Ou"
        ...
        "  <x:Interior>\015\012    <x:ColorIndex>None</x:ColorIndex>\015\012    <x:FillEf"
        "fect>\015\012     <x:fill x:type=\"Solid\" x:color=\"#000000\"/>\015\012    </x:"
        "FillEffect>\015\012   </x:Interior>\015\012   <x:Font>\015\012    <x:FontName>B "
        "Titr</x:FontName>\015\012    <x:Size>7</x:Size>\015\012    <x:Color>#FFD700</x:C"
        ...
        " 30روزه&quot;</x:Data>\015\012   </x:Caption>\015\012  </x:Title>\015\012  <x:Sc"
        "aling>\015\012   <x:ScaleID>515455100</x:ScaleID>\015\012  </x:Scaling>\015\012 "
        " <x:Scaling>\015\012   <x:ScaleID>515455304</x:ScaleID>\015\012  </x:Scaling>\015"
        "\012  <x:Scaling>\015\012   <x:ScaleID>515455508</x:ScaleID>\015\012  </x:Scalin"
