...
Begin Form
    ...
    RecSrcDt = Begin
        0x6ce9bdd99d90e540
    End
    RecordSource ="SELECT N_KOL, NUMBER, TNUMBER, NAME, TOZIH, BED_BES, ADDRESS, TEL, CODE_E, IDD, "
        "ECODE, PCODE, IYALAT, CITY, MCODEM, CUST_COD, MOBILE, ROUTE_NAME, OSTANID, SHAHR"
        "ID FROM TDETA_HES WHERE (N_KOL = 115) AND (NUMBER = 1)"
            ...
            Begin
                ...
                Begin UnboundObjectFrame
                    ...
                    OleData = Begin
                        ...
                        0x00000046000000000000000000000000c06f4cfbe95ad8010300000040010000 ,
