...
Begin Form
    ...
    RecordSource ="SELECT SUM(MAND) AS MANDS, col1, ANBAR, SUM(MANDF) AS MANDFS, ANBARN, NAMES, col"
        "2, col3, col4, col5 FROM AKMOGUDI_KOL_ANBAR_N_FANI(99999999, 1) AKMOGUDI_KOL_ANB"
        "AR_N_FANI GROUP BY col1, ANBAR, ANBARN, NAMES, col2, col3, col4, col5"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =1701
                    TabIndex =10
                    Name ="AK_MOGUDI_ANBAR_LIST_MP6"
                    SourceObject ="Form.AK_MOGUDI_ANBAR_LIST_MP6"
...
End
CodeBehindForm
' See "AK_MOGUDI_ANBAR_LIST_MP5.cls"
