...
Begin Form
    ...
    RecSrcDt = Begin
        0xbfa67ea76f64e540
    End
    RecordSource ="SELECT SUM(MABL_K) AS mabkk, col1, COUNT(CODE) AS cont FROM KHAREED_MP(1, 999999"
        "99) KHAREED_MP GROUP BY col1 ORDER BY SUM(MABL_K) DESC"
    Caption ="خريد"
                ...
                Begin Subform
                    ...
                    Begin
                        Begin Label
                            ...
                            Width =1095
                            Height =240
                            Name ="FROOSH_MP2 Label"
                            Caption ="FROOSH_MP2"
                            EventProcPrefix ="FROOSH_MP2_Label"
                        End
                    End
                End
                Begin TextBox
