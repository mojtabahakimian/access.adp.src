...
Begin Form
    ...
    RecSrcDt = Begin
        0xb0b2de8f6f64e540
    End
    RecordSource ="SELECT SUM(MABL_K) AS mabkk, col1,col2,col3,col4,col5,col6,col7, COUNT(CODE) AS "
        "cont FROM KHAREED_MP(1, 99999999) KHAREED_MP GROUP BY col1,col2,col3,col4,col5,c"
        "ol6,col7"
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ConditionalFormat = Begin
                        ...
                        0x0000000099336600000000000000000000000000000000000000000000000000 ,
                ...
                Begin Subform
                    ...
                    TabIndex =10
                    Name ="khareed_mp8"
                    SourceObject ="Form.khareed_mp8"
                    LinkChildFields ="col1;col2;col3;col4;col5;col6;col7"
                    LinkMasterFields ="col1;col2;col3;col4;col5;col6;col7"
                    Begin
                        Begin Label
                            OverlapFlags =93
                            Left =7350
                            ...
                            Width =1095
                            Height =240
                            Name ="FROOSH_MP8 Label"
                            Caption ="FROOSH_MP8"
                            EventProcPrefix ="FROOSH_MP8_Label"
                        End
                    End
                End
            End
