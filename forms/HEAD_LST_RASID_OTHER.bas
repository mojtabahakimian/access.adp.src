...
Begin Form
    ...
    RecSrcDt = Begin
        0xa7cede7bd3e1e440
    End
    RecordSource ="SELECT HEAD_LST.* FROM HEAD_LST WHERE (TAG = 24)"
    Caption ="رسيد انبار"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =6795
                    TabIndex =8
                    Name ="INVO_LST_RASID_SUB_OTHER"
                    SourceObject ="Form.INVO_LST_RASID_SUB_OTHER"
                ...
                Begin TextBox
                    ...
                    BackColor =13434828
                    Name ="Text59"
                    ControlSource ="=[INVO_LST_RASID_SUB_OTHER].[Form]![SMABLK]"
                    Begin
                        Begin Label
                            OverlapFlags =85
                            TextFontCharSet =0
