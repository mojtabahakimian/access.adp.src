...
Begin Form
    ...
    RecordSource ="SELECT SUM(MAND) AS MANDS, col1, ANBAR, SUM(MANDF) AS MANDFS, ANBARN, NAMES, col"
        "2, col3, col4, col5, col6, col7 , col8  FROM AKMOGUDI_KOL_ANBAR_N_FANI(99999999,"
        " 1) AKMOGUDI_KOL_ANBAR_N_FANI GROUP BY col1, ANBAR, ANBARN, NAMES, col2, col3, c"
        "ol4, col5, col6, col7, col8"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =1701
                    TabIndex =11
                    Name ="AK_MOGUDI_ANBAR_LIST_MP9"
                    SourceObject ="Form.AK_MOGUDI_ANBAR_LIST_MP9"
                    LinkChildFields ="col1;col2;col3;col4;col5;col6;col7;col8"
                    LinkMasterFields ="col1;col2;col3;col4;col5;col6;col7;col8"
                    Begin
                        Begin Label
                            OverlapFlags =93
                            Left =3201
...
End
CodeBehindForm
' See "AK_MOGUDI_ANBAR_LIST_MP8.cls"
