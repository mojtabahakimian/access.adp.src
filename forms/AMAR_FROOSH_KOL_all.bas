...
Begin Form
    ...
    RecordSource ="SELECT SUM(INVO_LST.MEGHk) AS MEGHT, dbo.Umonth(HEAD_LST.DATE_N) AS MON, MON.MON"
        ...
        "_ID WHERE (HEAD_LST.TAG = 2) GROUP BY dbo.Umonth(HEAD_LST.DATE_N), MON.MON ORDER"
        " BY dbo.Umonth(HEAD_LST.DATE_N)"
    Caption ="آمار فروش به تفكيك هر ماه"
    ...
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        "\012  <x:OWCVersion>10.0.0.5605         </x:OWCVersion>\015\012  <x:Width>37518<"
        ...
        ">\015\012     <x:Dimension>\015\012      <x:ScaleID>282356612</x:ScaleID>\015\012"
        "      <x:Index>Categories</x:Index>\015\012     </x:Dimension>\015\012     <x:Di"
        "mension>\015\012      <x:ScaleID>282356816</x:ScaleID>\015\012      <x:Index>Val"
        "ue</x:Index>\015\012     </x:Dimension>\015\012     <x:Dimension>\015\012      <"
        "x:ScaleID>282357020</x:ScaleID>\015\012      <x:Index>FormatValue</x:Index>\015\012"
        ...
        "  </x:Graph>\015\012    <x:Axis>\015\012     <x:AxisID>282332116</x:AxisID>\015\012"
        "     <x:ScaleID>282356612</x:ScaleID>\015\012     <x:Type>Category</x:Type>\015\012"
        ...
        "\012    </x:Axis>\015\012    <x:Axis>\015\012     <x:AxisID>282333284</x:AxisID>"
        "\015\012     <x:ScaleID>282356816</x:ScaleID>\015\012     <x:Type>Value</x:Type>"
        "\015\012     <x:Line>\015\012      <x:Weight>0</x:Weight>\015\012     </x:Line>\015"
        "\012     <x:MajorGridlines>\015\012     </x:MajorGridlines>\015\012     <x:Major"
        "Tick>Outside</x:MajorTick>\015\012     <x:MinorTick>None</x:MinorTick>\015\012  "
        "   <x:Title>\015\012      <x:Font>\015\012       <x:FontName>Tahoma</x:FontName>"
        "\015\012       <x:Size>10</x:Size>\015\012      </x:Font>\015\012      <x:Border"
        ">\015\012       <x:ColorIndex>None</x:ColorIndex>\015\012      </x:Border>\015\012"
        "      <x:Caption>\015\012       <x:DataSourceIndex>-1</x:DataSourceIndex>\015\012"
        "       <x:Data>&quot;مبلغ فروش&quot;</x:Data>\015\012      </x:Caption>\015\012 "
        "     <x:Position>Left</x:Position>\015\012     </x:Title>\015\012     <x:Placeme"
        "nt>Left</x:Placement>\015\012    </x:Axis>\015\012   </x:PlotArea>\015\012   <x:"
        "Identifier></x:Identifier>\015\012  </x:Chart>\015\012  <x:Title>\015\012   <x:F"
        "ont>\015\012    <x:FontName>Sina</x:FontName>\015\012    <x:Size>11</x:Size>\015"
        ...
        "   <x:Data>&quot;نمودار ميزان ريالي فروش در هر ماه  با بارگيري نشده ها&quot;</x:"
        "Data>\015\012   </x:Caption>\015\012  </x:Title>\015\012  <x:Scaling>\015\012   "
        "<x:ScaleID>282356612</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012"
        "   <x:ScaleID>282356816</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015"
        "\012   <x:ScaleID>282357020</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:HidePa"
        "ssiveAlert/>\015\012  <x:HideScreenTips/>\015\012 </x:ChartSpace>\015\012</xml>"
    AllowFormView =0
