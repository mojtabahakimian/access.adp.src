...
Begin Form
    ...
    RecSrcDt = Begin
        0x2bb9768adbbae540
    End
    RecordSource ="SELECT TOP(30) SUM(MABL) AS MAB, dbo.Uday(DATE) AS dd, dbo.Umonth(DATE) AS mm, D"
        "ATE FROM PAY_GETD GROUP BY dbo.Uday(DATE), dbo.Umonth(DATE), DATE ORDER BY DATE "
        "DESC"
    Caption ="مبلغ نقدي"
    ...
    PivotTableXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:WorksheetOpt"
        ...
        "   <x:Name>مبلغ كل</x:Name>\015\012   <x:SourceName>MAB</x:SourceName>\015\012  "
        ...
        "\015\012   <x:Name>روز</x:Name>\015\012   <x:SourceName>dd</x:SourceName>\015\012"
        "   <x:DataType>Integer</x:DataType>\015\012   <x:Orientation>Row</x:Orientation>"
        "\015\012   <x:Position>2</x:Position>\015\012   <x:EncodedType>adInteger</x:Enco"
        ...
        "\012   <x:Name>ماه</x:Name>\015\012   <x:SourceName>mm</x:SourceName>\015\012   "
        ...
        ":PivotField>\015\012  <x:PivotField>\015\012   <x:Name>روز1</x:Name>\015\012   <"
        "x:SourceName>DATE</x:SourceName>\015\012   <x:DataType>Number</x:DataType>\015\012"
        "   <x:PLCaption>روز</x:PLCaption>\015\012   <x:FilterCaption>روز</x:FilterCaptio"
        "n>\015\012   <x:EncodedType>adBigInt</x:EncodedType>\015\012   <x:CompareOrdered"
        "MembersBy>UniqueName</x:CompareOrderedMembersBy>\015\012  </x:PivotField>\015\012"
        "  <x:PivotField>\015\012   <x:Name>Data</x:Name>\015\012   <x:Orientation>Column"
        "</x:Orientation>\015\012   <x:Position>-1</x:Position>\015\012   <x:DataField/>\015"
        "\012  </x:PivotField>\015\012  <x:PivotField>\015\012   <x:Name>Sum of مبلغ كل</"
        "x:Name>\015\012   <x:PLName>Total1</x:PLName>\015\012   <x:TotalNumber>0</x:Tota"
        "lNumber>\015\012   <x:Orientation>Data</x:Orientation>\015\012   <x:Position>1</"
        "x:Position>\015\012   <x:ParentField>مبلغ كل</x:ParentField>\015\012  </x:PivotF"
        "ield>\015\012  <x:PivotData>\015\012   <x:Top>0.0.0</x:Top>\015\012   <x:TopOffs"
        "et>0</x:TopOffset>\015\012   <x:Left>0</x:Left>\015\012   <x:LeftOffset>0</x:Lef"
        "tOffset>\015\012   <x:SeqNum>685</x:SeqNum>\015\012  </x:PivotData>\015\012  <x:"
        "PivotView>\015\012   <x:IsNotFiltered/>\015\012   <x:Label>\015\012    <x:Captio"
    ...
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        "\012  <x:OWCVersion>10.0.0.6854         </x:OWCVersion>\015\012  <x:Width>42228<"
        "/x:Width>\015\012  <x:Height>19050</x:Height>\015\012  <x:DataSource>\015\012   "
        ...
        "der>\015\012   <x:Color>#000000</x:Color>\015\012  </x:Border>\015\012  <x:Inter"
        "ior>\015\012   <x:Color>#FF9900</x:Color>\015\012   <x:FillEffect>\015\012    <x"
        ":fill x:type=\"Solid\" x:color=\"#FF9900\"/>\015\012   </x:FillEffect>\015\012  "
        "</x:Interior>\015\012  <x:Chart>\015\012   <x:PlotArea>\015\012    <x:Interior>\015"
        "\012     <x:Color>#FFE4B5</x:Color>\015\012     <x:FillEffect>\015\012      <x:f"
        "ill x:type=\"Solid\" x:color=\"#FFE4B5\"/>\015\012     </x:FillEffect>\015\012  "
        ...
        " <x:ScaleID>259793440</x:ScaleID>\015\012      <x:Index>Categories</x:Index>\015"
        "\012     </x:Dimension>\015\012     <x:Dimension>\015\012      <x:ScaleID>259793"
        "644</x:ScaleID>\015\012      <x:Index>Value</x:Index>\015\012     </x:Dimension>"
        "\015\012     <x:Dimension>\015\012      <x:ScaleID>259793848</x:ScaleID>\015\012"
        ...
        "\012     <x:AxisID>259797084</x:AxisID>\015\012     <x:ScaleID>259793440</x:Scal"
        "eID>\015\012     <x:Type>TimeScale</x:Type>\015\012     <x:Font>\015\012      <x"
        ":FontName>Tahoma</x:FontName>\015\012      <x:Size>7</x:Size>\015\012      <x:B>"
        "Automatic</x:B>\015\012      <x:I>Automatic</x:I>\015\012      <x:U>Automatic</x"
        ":U>\015\012     </x:Font>\015\012     <x:Number>\015\012      <x:FormatString>mm"
        "/dd/yy</x:FormatString>\015\012     </x:Number>\015\012     <x:Alignment>\015\012"
        "      <x:Rotation>90</x:Rotation>\015\012     </x:Alignment>\015\012     <x:Majo"
        "rTick>Outside</x:MajorTick>\015\012     <x:MinorTick>Inside</x:MinorTick>\015\012"
        "     <x:Placement>Bottom</x:Placement>\015\012     <x:GroupingEnum>Auto</x:Group"
        "ingEnum>\015\012    </x:Axis>\015\012    <x:Axis>\015\012     <x:AxisID>25979797"
        "2</x:AxisID>\015\012     <x:ScaleID>259793644</x:ScaleID>\015\012     <x:Type>Va"
        "lue</x:Type>\015\012     <x:Font>\015\012      <x:Size>7</x:Size>\015\012      <"
        "x:B>Automatic</x:B>\015\012      <x:I>Automatic</x:I>\015\012      <x:U>Automati"
        "c</x:U>\015\012     </x:Font>\015\012     <x:Number>\015\012      <x:FormatStrin"
        "g>#,###</x:FormatString>\015\012     </x:Number>\015\012     <x:MajorTick>Outsid"
        "e</x:MajorTick>\015\012     <x:MinorTick>None</x:MinorTick>\015\012     <x:Place"
        "ment>Left</x:Placement>\015\012    </x:Axis>\015\012   </x:PlotArea>\015\012   <"
        "x:Identifier></x:Identifier>\015\012  </x:Chart>\015\012  <x:Title>\015\012   <x"
        ":Font>\015\012    <x:FontName>B Titr</x:FontName>\015\012    <x:Size>7</x:Size>\015"
        "\012    <x:Color>#A52A2A</x:Color>\015\012    <x:B>Automatic</x:B>\015\012    <x"
        ":I>Automatic</x:I>\015\012    <x:U>Automatic</x:U>\015\012   </x:Font>\015\012  "
        " <x:Border>\015\012    <x:ColorIndex>None</x:ColorIndex>\015\012   </x:Border>\015"
        "\012   <x:Caption>\015\012    <x:DataSourceIndex>-1</x:DataSourceIndex>\015\012 "
        "   <x:Data>&quot;مبلغ چکهاي دريافتي در 30 روز&quot;</x:Data>\015\012   </x:Capti"
        "on>\015\012  </x:Title>\015\012  <x:Scaling>\015\012   <x:ScaleID>259793440</x:S"
        "caleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>25979364"
        "4</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>25"
        "9793848</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:HidePassiveAlert/>\015\012"
