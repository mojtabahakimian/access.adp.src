...
Begin Form
    ...
    RecordSource ="SELECT SUM(MAND) AS MANDS, col1, ANBAR, SUM(MANDF) AS MANDFS, ANBARN, NAMES, col"
        "2, col3, col4 FROM AKMOGUDI_KOL_ANBAR_N_FANI(999999, 1) AKMOGUDI_KOL_ANBAR_N_FAN"
        "I GROUP BY col1, ANBAR, ANBARN, NAMES, col2, col3, col4"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT MPCODE, MPNAME FROM TCOD_MAP WHERE (MPP = 4)"
                    ColumnWidths ="0"
                    Begin
                        Begin Label
                            OverlapFlags =85
                ...
                Begin Subform
                    ...
                    Top =4560
                    TabIndex =9
                    Name ="AK_MOGUDI_ANBAR_LIST_MP5"
                    SourceObject ="Form.AK_MOGUDI_ANBAR_LIST_MP5"
                    LinkChildFields ="col1;col2;col3;col4"
                    LinkMasterFields ="col1;col2;col3;col4"
                    Begin
                        Begin Label
                            OverlapFlags =93
                            Left =1761
...
End
CodeBehindForm
' See "AK_MOGUDI_ANBAR_LIST_MP4.cls"
