            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT TDETA_HES.TNUMBER, TDETA_HES.NAME FROM TDETA_HES WHERE (((TDETA_HES.NUMBE"
                        "R)=[Forms]![HEAD_LST_KH_BACK]![PAY_GETP_BACK_SUB].[Form]![N_MOIN]) AND ((TDETA_H"
                        "ES.N_KOL)=[Forms]![Baseknow]![BANKHA])) GROUP BY TDETA_HES.TNUMBER, TDETA_HES.NA"
                        "ME ORDER BY TDETA_HES.NAME;"
                    ColumnWidths ="0"
                    Begin
                        Begin Label
                            OverlapFlags =247
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT TOTA_HES.NUMBER, TOTA_HES.NAME FROM TOTA_HES WHERE (((TOTA_HES.NUMBER)=[F"
                        "orms]![Baseknow]![BANKHA])) GROUP BY TOTA_HES.NUMBER, TOTA_HES.NAME ORDER BY TOT"
                        "A_HES.NAME;"
                    ColumnWidths ="0"
                    Begin
                        Begin Label
