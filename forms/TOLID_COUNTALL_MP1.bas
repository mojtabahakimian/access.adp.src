...
Begin Form
    ...
    RecSrcDt = Begin
        0xf973f7d693e4e340
    End
    RecordSource ="SELECT SUM(MEGHT) AS MEGHK, SAIZE, SUM(MEGHKF) AS MEGHF FROM AMAR_TOLID_FAREE(1,"
        " 9999999) AMAR_TOLID_FAREE GROUP BY SAIZE"
    Caption ="گزارش توليد به تفكيك سايز"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =5310
                    TabIndex =3
                    Name ="TOLID_COUNTALL_MP2"
                    SourceObject ="Form.TOLID_COUNTALL_MP2"
