...
Begin Form
    ...
    RecSrcDt = Begin
        0x3ab9919decdee340
    End
    RecordSource ="SELECT SUM(MEGHKF) AS MEGHF, SUM(MABK) AS MABKK, SUM(MEGHkK) AS MEGHk, SAIZE FRO"
        "M FROOSH_COUNTALL_CITY_N_FANI(1, 999999) FROOSH_COUNTALL_CITY_N_FANI GROUP BY SA"
        "IZE"
    Caption ="گزارش فروش به تفكيك سايز"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =5310
                    TabIndex =4
                    Name ="FROOSH_COUNTALL_MP2"
                    SourceObject ="Form.FROOSH_COUNTALL_MP2"
                    LinkChildFields ="SAIZE"
                    LinkMasterFields ="SAIZE"
                End
                Begin ComboBox
                    OldBorderStyle =0
                    OverlapFlags =85
