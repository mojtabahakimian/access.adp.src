...
Begin Form
    ...
    RecSrcDt = Begin
        0x8abd163ff04be340
    End
    ServerFilter ="GRP = 5 AND VH = 1"
    RecordSource ="AMAR_KOL_TOLID_KALA"
    Caption ="آمار توليد به تفكيك هر ماه و گروه كالا"
    ...
    PivotTableXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:WorksheetOpt"
        ...
        "RP</x:Name>\015\012   <x:DataType>Number</x:DataType>\015\012   <x:EncodedType>a"
        "dDouble</x:EncodedType>\015\012   <x:CompareOrderedMembersBy>UniqueName</x:Compa"
        "reOrderedMembersBy>\015\012   <x:NoDisplayInFieldList/>\015\012  </x:PivotField>"
        "\015\012  <x:PivotField>\015\012   <x:Name>VH</x:Name>\015\012   <x:DataType>Int"
        "eger</x:DataType>\015\012   <x:EncodedType>adInteger</x:EncodedType>\015\012   <"
        ...
        "<x:Name>Data</x:Name>\015\012   <x:Orientation>Column</x:Orientation>\015\012   "
        "<x:Position>-1</x:Position>\015\012   <x:DataField/>\015\012  </x:PivotField>\015"
        "\012  <x:PivotField>\015\012   <x:Name>Sum of مقدار</x:Name>\015\012   <x:PLName"
        ">Total1</x:PLName>\015\012   <x:TotalNumber>0</x:TotalNumber>\015\012   <x:Orien"
        "tation>Data</x:Orientation>\015\012   <x:Position>1</x:Position>\015\012   <x:Pa"
        "rentField>مقدار</x:ParentField>\015\012  </x:PivotField>\015\012  <x:PivotData>\015"
        "\012   <x:Top>0.0.0</x:Top>\015\012   <x:TopOffset>0</x:TopOffset>\015\012   <x:"
        "Left>0</x:Left>\015\012   <x:LeftOffset>0</x:LeftOffset>\015\012   <x:SeqNum>10<"
        "/x:SeqNum>\015\012  </x:PivotData>\015\012  <x:PivotView>\015\012   <x:DetailSor"
        "tOrder>MON</x:DetailSortOrder>\015\012   <x:Label>\015\012    <x:Caption>Microso"
        "ft Office PivotTable 10.0</x:Caption>\015\012    <x:NotVisible/>\015\012   </x:L"
        "abel>\015\012   <x:AllowEdits>false</x:AllowEdits>\015\012   <x:AllowAdditions>f"
        "alse</x:AllowAdditions>\015\012   <x:AllowDeletions>false</x:AllowDeletions>\015"
        "\012  </x:PivotView>\015\012 </x:PivotTable>\015\012</xml>"
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        ...
        "/x:Width>\015\012  <x:Height>10689</x:Height>\015\012  <x:DataSource>\015\012   "
        ...
        "\015\012      <x:ScaleID>149436764</x:ScaleID>\015\012      <x:Index>Categories<"
        "/x:Index>\015\012     </x:Dimension>\015\012     <x:Dimension>\015\012      <x:S"
        "caleID>149436968</x:ScaleID>\015\012      <x:Index>Value</x:Index>\015\012     <"
        "/x:Dimension>\015\012     <x:Dimension>\015\012      <x:ScaleID>149437172</x:Sca"
        ...
        "x:Axis>\015\012     <x:AxisID>149430060</x:AxisID>\015\012     <x:ScaleID>149436"
        "764</x:ScaleID>\015\012     <x:Type>Category</x:Type>\015\012     <x:Font>\015\012"
        "      <x:FontName>Tahoma</x:FontName>\015\012      <x:Size>8</x:Size>\015\012   "
        "   <x:B>Automatic</x:B>\015\012      <x:I>Automatic</x:I>\015\012      <x:U>Auto"
        "matic</x:U>\015\012     </x:Font>\015\012     <x:MajorTick>Outside</x:MajorTick>"
        "\015\012     <x:MinorTick>None</x:MinorTick>\015\012     <x:Placement>Bottom</x:"
        "Placement>\015\012     <x:GroupingEnum>Auto</x:GroupingEnum>\015\012    </x:Axis"
        ">\015\012    <x:Axis>\015\012     <x:AxisID>149442184</x:AxisID>\015\012     <x:"
        "ScaleID>149436968</x:ScaleID>\015\012     <x:Type>Value</x:Type>\015\012     <x:"
        "Line>\015\012      <x:Weight>0</x:Weight>\015\012     </x:Line>\015\012     <x:M"
        "ajorGridlines>\015\012     </x:MajorGridlines>\015\012     <x:MajorTick>Outside<"
        "/x:MajorTick>\015\012     <x:MinorTick>None</x:MinorTick>\015\012     <x:Title>\015"
        "\012      <x:Font>\015\012       <x:FontName>Tahoma</x:FontName>\015\012       <"
        "x:Size>10</x:Size>\015\012      </x:Font>\015\012      <x:Border>\015\012       "
        "<x:ColorIndex>None</x:ColorIndex>\015\012      </x:Border>\015\012      <x:Capti"
        "on>\015\012       <x:DataSourceIndex>-1</x:DataSourceIndex>\015\012       <x:Dat"
        "a>&quot;ميزان توليد&quot;</x:Data>\015\012      </x:Caption>\015\012      <x:Pos"
        "ition>Left</x:Position>\015\012     </x:Title>\015\012     <x:Placement>Left</x:"
        "Placement>\015\012    </x:Axis>\015\012   </x:PlotArea>\015\012   <x:Identifier>"
        "</x:Identifier>\015\012  </x:Chart>\015\012  <x:Title>\015\012   <x:Font>\015\012"
        "    <x:FontName>Sina</x:FontName>\015\012    <x:Size>10</x:Size>\015\012    <x:C"
        "olor>#A52A2A</x:Color>\015\012    <x:B>Automatic</x:B>\015\012    <x:I>Automatic"
        "</x:I>\015\012    <x:U>Automatic</x:U>\015\012   </x:Font>\015\012   <x:Border>\015"
        ...
        "uot;نمودار ميزان توليد محصولات در هر ماه&quot;</x:Data>\015\012   </x:Caption>\015"
        "\012  </x:Title>\015\012  <x:Scaling>\015\012   <x:ScaleID>149436764</x:ScaleID>"
        "\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>149436968</x:Sc"
        "aleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>149437172"
