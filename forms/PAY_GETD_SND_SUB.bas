            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT DETA_HES.NUMBER, DETA_HES.NAME FROM DETA_HES WHERE (((DETA_HES.N_KOL)=[Fo"
                        "rms]![HEAD_LST_FROOSH_SND]![PAY_GETD_SND_SUB].[Form]![N_KOL])) GROUP BY DETA_HES"
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT TDETA_HES.TNUMBER, TDETA_HES.NAME FROM TDETA_HES WHERE (((TDETA_HES.NUMBE"
                        "R)=[Forms]![HEAD_LST_FROOSH_SND]![PAY_GETD_SND_SUB].[Form]![N_MOIN]) AND ((TDETA"
                        "_HES.N_KOL)=[Forms]![HEAD_LST_FROOSH_SND]![PAY_GETD_SND_SUB].[Form]![N_KOL])) GR"
                        "OUP BY TDETA_HES.TNUMBER, TDETA_HES.NAME ORDER BY TDETA_HES.NAME;"
                    ColumnWidths ="0"
                    Begin
                        Begin Label
                            OverlapFlags =215
