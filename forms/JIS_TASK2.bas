...
Begin Form
    ...
    RecSrcDt = Begin
        0x75a53dd6343ce440
    End
    RecordSource ="SELECT TASKS.IDNUM, TASKS.GR, TASKS.PERSONEL, TASKS.TASK, TASKS.PERIORITY, TASKS"
        ".STATUS, TASKS.STDATE, TASKS.STTIME, TASKS.ENDATE, TASKS.ENTIME, TASKS.USERNAME,"
        " TASKS.COMP_COD, TASKS.SUMTIME, TASKS.ss FROM TASKS LEFT OUTER JOIN EVENTS ON TA"
        "SKS.IDNUM = EVENTS.IDNUM WHERE (EVENTS.EVENTS LIKE N'%') GROUP BY TASKS.IDNUM, T"
        "ASKS.GR, TASKS.PERSONEL, TASKS.TASK, TASKS.PERIORITY, TASKS.STATUS, TASKS.STDATE"
        ", TASKS.STTIME, TASKS.ENDATE, TASKS.ENTIME, TASKS.USERNAME, TASKS.COMP_COD, TASK"
        "S.ss, TASKS.SUMTIME"
    Caption ="وظايف"
