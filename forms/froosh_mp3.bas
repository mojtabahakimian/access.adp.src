...
Begin Form
    ...
    RecSrcDt = Begin
        0xfda0a47cf152e540
    End
    RecordSource ="SELECT SUM(MABL_K) AS mabkk, col1,col2,col3, COUNT(CODE) AS cont FROM FROOSH_MP("
        "1, 99999999) FROOSH_MP GROUP BY col1,col2,col3"
