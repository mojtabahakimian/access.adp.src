...
Begin Form
    ...
    Tag ="@Forms___FMENU_TARAZ_4___DT1 = [Forms]![FMENU_TARAZ_4]![DT1],@Forms___FMENU_TARA"
        ...
        "ARAZ_4]![SNDNUM2],@KOL=FORMS![TARAZ_4_MOIN]![N_KOL],@MOIN=FORMS![TARAZ_4_MOIN]!["
        "NUMBER]"
    RecSrcDt = Begin
        0x2a9b244935ebe340
    End
    InputParameters ="@Forms___FMENU_TARAZ_4___DT1 = [Forms]![FMENU_TARAZ_4]![DT1],@Forms___FMENU_TARA"
        ...
        "IRECT]![NUMBER],@TAF=FORMS![TARAZ_TAF_DIRECT]![TNUMBER]"
    RecordSource ="dbo.TARAZ4_TAFZ2_DIRECT"
    Caption ="تراز آزمايشي چهار ستوني  تفصيلي"
    ...
    UnknownProp = {258 ,66 ,12 ,4 ,750 } Begin
        ...
        0x4e0055004d004200450052005d00
    End
