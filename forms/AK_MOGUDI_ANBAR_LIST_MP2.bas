...
Begin Form
    ...
    RecordSource ="SELECT SUM(MAND) AS MANDS, col1, ANBAR, SUM(MANDF) AS MANDFS, ANBARN, NAMES, col"
        "2, CAST(col2 AS int) AS col22 FROM AKMOGUDI_KOL_ANBAR_N_FANI(999999, 1) AKMOGUDI"
        "_KOL_ANBAR_N_FANI GROUP BY col1, ANBAR, ANBARN, NAMES, CAST(col2 AS int), col2"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =5310
                    TabIndex =6
                    Name ="AK_MOGUDI_ANBAR_LIST_MP3"
                    SourceObject ="Form.AK_MOGUDI_ANBAR_LIST_MP3"
                    LinkChildFields ="col1;col2"
                    LinkMasterFields ="col1;col2"
                    Begin
                        Begin Label
                            OverlapFlags =93
                            Left =3795
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT MPCODE, MPNAME FROM TCOD_MAP WHERE (MPP = 2)"
                    ColumnWidths ="0"
...
End
CodeBehindForm
' See "AK_MOGUDI_ANBAR_LIST_MP2.cls"
