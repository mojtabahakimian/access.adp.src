...
Begin Form
    ...
    MaxRecords =0
    Filter ="(((SUDDAYT.DATE_S>\"13981000\"))) AND ((SUDDAYT.DATE_S<\"13981032\"))"
    RecSrcDt = Begin
        0x87b3ab677aefe440
    End
    RecordSource ="SUDDAYT"
    Caption ="نبض سود(سود روزانه)"
    ...
    PivotTableXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:WorksheetOpt"
        ...
        "   <x:Name>تاريخ</x:Name>\015\012   <x:SourceName>DATE_S</x:SourceName>\015\012 "
        ...
        "PivotData>\015\012   <x:Top>0.0</x:Top>\015\012   <x:TopOffset>0</x:TopOffset>\015"
        "\012   <x:Left>0</x:Left>\015\012   <x:LeftOffset>0</x:LeftOffset>\015\012   <x:"
        "SeqNum>58</x:SeqNum>\015\012  </x:PivotData>\015\012  <x:PivotView>\015\012   <x"
        ":IsNotFiltered/>\015\012   <x:Label>\015\012    <x:Caption>Microsoft Office Pivo"
        "tTable 10.0</x:Caption>\015\012    <x:NotVisible/>\015\012   </x:Label>\015\012 "
        "  <x:AllowEdits>false</x:AllowEdits>\015\012   <x:AllowAdditions>false</x:AllowA"
        "dditions>\015\012   <x:AllowDeletions>false</x:AllowDeletions>\015\012  </x:Pivo"
        "tView>\015\012 </x:PivotTable>\015\012</xml>"
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        "\012  <x:OWCVersion>10.0.0.5605         </x:OWCVersion>\015\012  <x:Width>37994<"
        "/x:Width>\015\012  <x:Height>14843</x:Height>\015\012  <x:DataSource>\015\012   "
        ...
        "    <x:Name>Series</x:Name>\015\012      <x:Caption>\015\012       <x:DataSource"
        "Index>-1</x:DataSourceIndex>\015\012       <x:Data>&quot;Series&quot;</x:Data>\015"
        "\012      </x:Caption>\015\012      <x:Index>0</x:Index>\015\012      <x:Categor"
        ...
        "x>\015\012       <x:Data>Total1</x:Data>\015\012      </x:Value>\015\012      <x"
        ...
        "leID>194531940</x:ScaleID>\015\012      <x:Index>Categories</x:Index>\015\012   "
        "  </x:Dimension>\015\012     <x:Dimension>\015\012      <x:ScaleID>194532144</x:"
        "ScaleID>\015\012      <x:Index>Value</x:Index>\015\012     </x:Dimension>\015\012"
        "     <x:Dimension>\015\012      <x:ScaleID>194532348</x:ScaleID>\015\012      <x"
        ...
        "eAngle>0</x:FirstSliceAngle>\015\012    </x:Graph>\015\012    <x:Graph>\015\012 "
        "    <x:Type>Line</x:Type>\015\012     <x:SubType>Standard</x:SubType>\015\012   "
        "  <x:Dimension>\015\012      <x:ScaleID>194531940</x:ScaleID>\015\012      <x:In"
        "dex>Categories</x:Index>\015\012     </x:Dimension>\015\012     <x:Dimension>\015"
        "\012      <x:ScaleID>194532144</x:ScaleID>\015\012      <x:Index>Value</x:Index>"
        "\015\012     </x:Dimension>\015\012     <x:Dimension>\015\012      <x:ScaleID>19"
        "4532348</x:ScaleID>\015\012      <x:Index>FormatValue</x:Index>\015\012     </x:"
        ...
        "raph>\015\012    <x:Axis>\015\012     <x:AxisID>194537308</x:AxisID>\015\012    "
        " <x:ScaleID>194531940</x:ScaleID>\015\012     <x:Type>Category</x:Type>\015\012 "
        ...
        "D>194537916</x:AxisID>\015\012     <x:ScaleID>194532144</x:ScaleID>\015\012     "
        ...
        ">\015\012  </x:Chart>\015\012  <x:Scaling>\015\012   <x:ScaleID>194531940</x:Sca"
        "leID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>194532144<"
        "/x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015\012   <x:ScaleID>1945"
        "32348</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:HidePassiveAlert/>\015\012  "
