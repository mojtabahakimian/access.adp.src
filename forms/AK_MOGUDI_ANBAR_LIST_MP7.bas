...
Begin Form
    ...
    RecordSource ="SELECT SUM(MAND) AS MANDS, col1, ANBAR, SUM(MANDF) AS MANDFS, ANBARN, NAMES, col"
        "2, col3, col4, col5, col6, col7 FROM AKMOGUDI_KOL_ANBAR_N_FANI(99999999, 1) AKMO"
        "GUDI_KOL_ANBAR_N_FANI GROUP BY col1, ANBAR, ANBARN, NAMES, col2, col3, col4, col"
        "5, col6, col7"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =1701
                    TabIndex =11
                    Name ="AK_MOGUDI_ANBAR_LIST_MP8"
                    SourceObject ="Form.AK_MOGUDI_ANBAR_LIST_MP8"
...
End
CodeBehindForm
' See "AK_MOGUDI_ANBAR_LIST_MP7.cls"
