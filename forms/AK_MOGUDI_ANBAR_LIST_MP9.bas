...
Begin Form
    ...
    RecordSource ="SELECT SUM(MAND) AS MANDS, col1, ANBAR, SUM(MANDF) AS MANDFS, ANBARN, NAMES, col"
        "2, col3, col4, col5, col6, col7 , col8, col9  FROM AKMOGUDI_KOL_ANBAR_N_FANI(999"
        "99999, 1) AKMOGUDI_KOL_ANBAR_N_FANI GROUP BY col1, ANBAR, ANBARN, NAMES, col2, c"
        "ol3, col4, col5, col6, col7, col8, col9"
...
End
CodeBehindForm
' See "AK_MOGUDI_ANBAR_LIST_MP9.cls"
