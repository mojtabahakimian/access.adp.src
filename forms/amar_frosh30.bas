...
Begin Form
    ...
    RecSrcDt = Begin
        0x26caf24db4f0e540
    End
    RecordSource ="SELECT top(30) SUM(INVO_LST.MEGHk) AS MEGHT, dbo.Uday(HEAD_LST.DATE_N) AS dd, db"
        ...
        "AD_LST.DATE_N)\015\012ORDER BY HEAD_LST.DATE_N DESC"
    Caption ="فروش30 روزه"
    ...
    PivotTableXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:WorksheetOpt"
        ...
        ">\015\012   <x:LeftOffset>0</x:LeftOffset>\015\012   <x:SeqNum>95</x:SeqNum>\015"
    ...
    PivotChartXML ="<xml xmlns:x=\"urn:schemas-microsoft-com:office:excel\">\015\012 <x:ChartSpace>\015"
        ...
        "  </x:Border>\015\012  <x:Interior>\015\012   <x:Color>#CCFFCC</x:Color>\015\012"
        "   <x:FillEffect>\015\012    <x:fill x:type=\"Solid\" x:color=\"#CCFFCC\"/>\015\012"
        ...
        "\012     </x:Series>\015\012     <x:Dimension>\015\012      <x:ScaleID>469578556"
        "</x:ScaleID>\015\012      <x:Index>Categories</x:Index>\015\012     </x:Dimensio"
        "n>\015\012     <x:Dimension>\015\012      <x:ScaleID>469578760</x:ScaleID>\015\012"
        "      <x:Index>Value</x:Index>\015\012     </x:Dimension>\015\012     <x:Dimensi"
        "on>\015\012      <x:ScaleID>469578964</x:ScaleID>\015\012      <x:Index>FormatVa"
        ...
        "2344</x:AxisID>\015\012     <x:ScaleID>469578556</x:ScaleID>\015\012     <x:Type"
        ...
        "x:Axis>\015\012     <x:AxisID>469582580</x:AxisID>\015\012     <x:ScaleID>469578"
        "760</x:ScaleID>\015\012     <x:Type>Value</x:Type>\015\012     <x:Font>\015\012 "
        ...
        "rceIndex>-1</x:DataSourceIndex>\015\012    <x:Data>&quot; مبلغ فروش  30 روزه&quo"
        "t;</x:Data>\015\012   </x:Caption>\015\012  </x:Title>\015\012  <x:Scaling>\015\012"
        "   <x:ScaleID>469578556</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scaling>\015"
        "\012   <x:ScaleID>469578760</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:Scalin"
        "g>\015\012   <x:ScaleID>469578964</x:ScaleID>\015\012  </x:Scaling>\015\012  <x:"
        "HidePassiveAlert/>\015\012  <x:HideScreenTips/>\015\012 </x:ChartSpace>\015\012<"
        "/xml>"
    AllowFormView =0
